  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}v();function v(){e=new Ht(70,window.innerWidth/window.innerHeight,.1,100),e.position.z=2,t=new Jx;let A={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:d.getDelta()}};a=new or(10,10,1),o=new kt({uniforms:A,fragmentShader:_(),vertexShader:p()}),s=new Zt(a,o),t.add(s),i=new Zx({antialias:!0}),i.setPixelRatio(window.devicePixelRatio),i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(b),document.body.appendChild(i.domElement).id="glitch",r=new cS(i);const z=new uS(t,e);r.addPass(z);const C=new dS;r.addPass(C),window.addEventListener("resize",m)}function m(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}let h=!0;function b(){d.update(),o.uniforms.time.value=d.getElapsed(),l.path==="/"?(h=!0,r.render()):h&&(i.clear(),h=!1)}function S(A){c.value=A}return window.addEventListener("wheel",A=>{let z="home";A.deltaY<0&&f.value>0?f.value--:A.deltaY>0&&f.value<u.value.length-1&&f.value++,z=u.value[f.value],S(z),document.getElementById(z+"-link").click()}),(A,z)=>(Nr(),Fr(sn,null,[WM,XM,qM,KM,De("nav",$M,[De("ul",null,[De("div",YM,[De("li",null,[De("a",{id:"home-link",class:xi({active:c.value==="home"}),onClick:z[0]||(z[0]=C=>S("home")),href:"#home"},"Home_",2)])]),De("div",jM,[De("li",null,[De("a",{id:"about-me-link",class:xi({active:c.value==="about-me"}),onClick:z[1]||(z[1]=C=>S("about-me")),href:"#about-me"},"About_Me_",2)]),De("li",null,[De("a",{id:"projects-link",class:xi({active:c.value==="projects"}),onClick:z[2]||(z[2]=C=>S("projects")),href:"#projects"},"Projects_",2)])])])]),De("section",ZM,[yt(MM)]),De("section",JM,[yt(gd)]),De("section",QM,[yt(vd)]),De("section",ey,[yt(_d)]),ty],64))}}),iy=lr(ny,[["__scopeId","data-v-805db362"]]),ry={};function sy(n,e,t,i,r,s){return null}const oy=lr(ry,[["render",sy]]),ay=[{path:"/",component:oy},{path:"/about-me",component:gd},{path:"/projects",component:vd},{path:"/contact",component:_d}],ly=hM({history:VS(),routes:ay});Hp(iy).use(ly).mount("#app");

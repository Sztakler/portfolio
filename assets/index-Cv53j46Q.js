...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function fu(){return new Kt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fl(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function du(){return new Kt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fl(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Zx(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===ed?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===wm?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===An&&(e="SHADOWMAP_TYPE_VSM"),e}function Jx(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case lr:case cr:e="ENVMAP_TYPE_CUBE";break;case fo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Qx(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case cr:e="ENVMAP_MODE_REFRACTION";break}return e}function eS(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case td:e="ENVMAP_BLENDING_MULTIPLY";break;case Qm:e="ENVMAP_BLENDING_MIX";break;case eg:e="ENVMAP_BLENDING_ADD";break}return e}function tS(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function nS(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Zx(t),c=Jx(t),u=Qx(t),f=eS(t),d=tS(t),h=kx(t),_=Wx(s),v=r.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Cr).join(`
`)),o=Na(o),o=Mu(o,t),o=yu(o,t),a=Na(a),a=Mu(a,t),a=yu(a,t),o=Eu(o),a=Eu(a),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class $S extends Yr{constructor(){super();const e=KS;this.uniforms=ul.clone(e.uniforms),this.material=new NS({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new Od(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,i){this.uniforms.tDiffuse.value=i.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Je.getTransfer(this._outputColorSpace)===nt&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===nd?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===id?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===rd?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===sd?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===od?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===ad&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}/*!
  * vue-router v4.4.0
  * (c) 2024 Eduardo San Martin Morote
  * @license MIT
  */const Ji=typeof document<"u";function YS(n){return n.__esModule||n[Symbol.toStringTag]==="Module"}const rt=Object.assign;function fa(n,e){const t={};for(const i in e){const r=e[i];t[i]=sn(r)?r.map(n):n(r)}return t}const Nr=()=>{},sn=Array.isArray,zd=/#/g,jS=/&/g,ZS=/\//g,JS=/=/g,QS=/\?/g,Bd=/\+/g,eM=/%5B/g,tM=/%5D/g,Hd=/%5E/g,nM=/%60/g,Vd=/%7B/g,iM=/%7C/g,Gd=/%7D/g,rM=/%20/g;function dl(n){return encodeURI(""+n).replace(iM,"|").replace(eM,"[").replace(tM,"]")}function sM(n){return dl(n).replace(Vd,"{").replace(Gd,"}").replace(Hd,"^")}function Fa(n){return dl(n).replace(Bd,"%2B").replace(rM,"+").replace(zd,"%23").replace(jS,"%26").replace(nM,"`").replace(Vd,"{").replace(Gd,"}").replace(Hd,"^")}function oM(n){return Fa(n).replace(JS,"%3D")}function aM(n){return dl(n).replace(zd,"%23").replace(QS,"%3F")}function lM(n){return n==null?"":aM(n).replace(ZS,"%2F")}function Gr(n){try{return decodeURIComponent(""+n)}catch{}return""+n}const cM=/\/$/,uM=n=>n.replace(cM,"");function da(n,e,t="/"){let i,r={},s="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(i=e.slice(0,l),s=e.slice(l+1,a>-1?a:e.length),r=n(s)),a>-1&&(i=i||e.slice(0,a),o=e.slice(a,e.length)),i=pM(i??e,t),{fullPath:i+(s&&"?")+s+o,path:i,query:r,hash:Gr(o)}}function fM(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function dM(n,e,t){const i=e.matched.length-1,r=t.matched.length-1;return i>-1&&i===r&&pr(e.matched[i],t.matched[r])&&kd(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function pr(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function kd(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(const t in n)if(!hM(n[t],e[t]))return!1;return!0}function hM(n,e){return sn(n)?Pu(n,e):sn(e)?Pu(e,n):n===e}function Pu(n,e){return sn(e)?n.length===e.length&&n.every((t,i)=>t===e[i]):n.length===1&&n[0]===e}function pM(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),i=n.split("/"),r=i[i.length-1];(r===".."||r===".")&&i.push("");let s=t.length-1,o,a;for(o=0;o<i.length;o++)if(a=i[o],a!==".")if(a==="..")s>1&&s--;else break;return t.slice(0,s).join("/")+"/"+i.slice(o).join("/")}const Xn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var kr;(function(n){n.pop="pop",n.push="push"})(kr||(kr={}));var Zs;(function(n){n.back="back",n.forward="forward",n.unknown=""})(Zs||(Zs={}));const ha="";function mM(n){if(!n)if(Ji){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),uM(n)}const gM=/^[^#]+#/;function _M(n,e){return n.replace(gM,"#")+e}function vM(n,e){const t=document.documentElement.getBoundingClientRect(),i=n.getBoundingClientRect();return{behavior:e.behavior,left:i.left-t.left-(e.left||0),top:i.top-t.top-(e.top||0)}}const xM=()=>({left:window.scrollX,top:window.scrollY});function SM(n){let e;if("el"in n){const t=n.el,i=typeof t=="string"&&t.startsWith("#"),r=typeof t=="string"?i?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!r)return;e=vM(r,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function Lu(n,e){return(history.state?history.state.position-e:-1)+n}const Oa=new Map;function MM(n,e){Oa.set(n,e)}function yM(n){const e=Oa.get(n);return Oa.delete(n),e}function EM(n=""){let e=[],t=[ha],i=0;n=mM(n);function r(a){i++,i!==t.length&&t.splice(i),t.push(a)}function s(a,l,{direction:c,delta:u}){const f={direction:c,delta:u,type:kr.pop};for(const d of e)d(a,l,f)}const o={location:ha,state:{},base:n,createHref:_M.bind(null,n),replace(a){t.splice(i--,1),r(a)},push(a,l){r(a)},listen(a){return e.push(a),()=>{const l=e.indexOf(a);l>-1&&e.splice(l,1)}},destroy(){e=[],t=[ha],i=0},go(a,l=!0){const c=this.location,u=a<0?Zs.back:Zs.forward;i=Math.max(0,Math.min(i+a,t.length-1)),l&&s(this.location,c,{direction:u,delta:a})}};return Object.defineProperty(o,"location",{enumerable:!0,get:()=>t[i]}),o}function TM(n){return typeof n=="string"||n&&typeof n=="object"}function Wd(n){return typeof n=="string"||typeof n=="symbol"}const Xd=Symbol("");var Iu;(function(n){n[n.aborted=4]="aborted",n[n.cancelled=8]="cancelled",n[n.duplicated=16]="duplicated"})(Iu||(Iu={}));function mr(n,e){return rt(new Error,{type:n,[Xd]:!0},e)}function bn(n,e){return n instanceof Error&&Xd in n&&(e==null||!!(n.type&e))}const Du="[^/]+?",bM={sensitive:!1,strict:!1,start:!0,end:!0},AM=/[.+*?^${}()[\]/\\]/g;function wM(n,e){const t=rt({},bM,e),i=[];let r=t.start?"^":"";const s=[];for(const c of n){const u=c.length?[]:[90];t.strict&&!c.length&&(r+="/");for(let f=0;f<c.length;f++){const d=c[f];let h=40+(t.sensitive?.25:0);if(d.type===0)f||(r+="/"),r+=d.value.replace(AM,"\\$&"),h+=40;else if(d.type===1){const{value:_,repeatable:v,optional:m,regexp:p}=d;s.push({name:_,repeatable:v,optional:m});const b=p||Du;if(b!==Du){h+=10;try{new RegExp(`(${b})`)}catch(A){throw new Error(`Invalid custom RegExp for param "${_}" (${b}): `+A.message)}}let S=v?`((?:${b})(?:/(?:${b}))*)`:`(${b})`;f||(S=m&&c.length<2?`(?:/${S})`:"/"+S),m&&(S+="?"),r+=S,h+=20,m&&(h+=-8),v&&(h+=-20),b===".*"&&(h+=-50)}u.push(h)}i.push(u)}if(t.strict&&t.end){const c=i.length-1;i[c][i[c].length-1]+=.7000000000000001}t.strict||(r+="/?"),t.end?r+="$":t.strict&&(r+="(?:/|$)");const o=new RegExp(r,t.sensitive?"":"i");function a(c){const u=c.match(o),f={};if(!u)return null;for(let d=1;d<u.length;d++){const h=u[d]||"",_=s[d-1];f[_.name]=h&&_.repeatable?h.split("/"):h}return f}function l(c){let u="",f=!1;for(const d of n){(!f||!u.endsWith("/"))&&(u+="/"),f=!1;for(const h of d)if(h.type===0)u+=h.value;else if(h.type===1){const{value:_,repeatable:v,optional:m}=h,p=_ in c?c[_]:"";if(sn(p)&&!v)throw new Error(`Provided param "${_}" is an array but it is not repeatable (* or + modifiers)`);const b=sn(p)?p.join("/"):p;if(!b)if(m)d.length<2&&(u.endsWith("/")?u=u.slice(0,-1):f=!0);else throw new Error(`Missing required param "${_}"`);u+=b}}return u||"/"}return{re:o,score:i,keys:s,parse:a,stringify:l}}function RM(n,e){let t=0;for(;t<n.length&&t<e.length;){const i=e[t]-n[t];if(i)return i;t++}return n.length<e.length?n.length===1&&n[0]===80?-1:1:n.length>e.length?e.length===1&&e[0]===80?1:-1:0}function qd(n,e){let t=0;const i=n.score,r=e.score;for(;t<i.length&&t<r.length;){const s=RM(i[t],r[t]);if(s)return s;t++}if(Math.abs(r.length-i.length)===1){if(Uu(i))return 1;if(Uu(r))return-1}return r.length-i.length}function Uu(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const CM={type:0,value:""},PM=/[a-zA-Z0-9_]/;function LM(n){if(!n)return[[]];if(n==="/")return[[CM]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e(h){throw new Error(`ERR (${t})/"${c}": ${h}`)}let t=0,i=t;const r=[];let s;function o(){s&&r.push(s),s=[]}let a=0,l,c="",u="";function f(){c&&(t===0?s.push({type:0,value:c}):t===1||t===2||t===3?(s.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function d(){c+=l}for(;a<n.length;){if(l=n[a++],l==="\\"&&t!==2){i=t,t=4;continue}switch(t){case 0:l==="/"?(c&&f(),o()):l===":"?(f(),t=1):d();break;case 4:d(),t=i;break;case 1:l==="("?t=2:PM.test(l)?d():(f(),t=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:t=3:u+=l;break;case 3:f(),t=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,u="";break;default:e("Unknown state");break}}return t===2&&e(`Unfinished custom RegExp for param "${c}"`),f(),o(),r}function IM(n,e,t){const i=wM(LM(n.path),t),r=rt(i,{record:n,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function DM(n,e){const t=[],i=new Map;e=Ou({strict:!1,end:!0,sensitive:!1},e);function r(f){return i.get(f)}function s(f,d,h){const _=!h,v=UM(f);v.aliasOf=h&&h.record;const m=Ou(e,f),p=[v];if("alias"in f){const A=typeof f.alias=="string"?[f.alias]:f.alias;for(const z of A)p.push(rt({},v,{components:h?h.record.components:v.components,path:z,aliasOf:h?h.record:v}))}let b,S;for(const A of p){const{path:z}=A;if(d&&z[0]!=="/"){const R=d.record.path,P=R[R.length-1]==="/"?"":"/";A.path=d.record.path+(z&&P+z)}if(b=IM(A,d,m),h?h.alias.push(b):(S=S||b,S!==b&&S.alias.push(b),_&&f.name&&!Fu(b)&&o(f.name)),Kd(b)&&l(b),v.children){const R=v.children;for(let P=0;P<R.length;P++)s(R[P],b,h&&h.children[P])}h=h||b}return S?()=>{o(S)}:Nr}function o(f){if(Wd(f)){const d=i.get(f);d&&(i.delete(f),t.splice(t.indexOf(d),1),d.children.forEach(o),d.alias.forEach(o))}else{const d=t.indexOf(f);d>-1&&(t.splice(d,1),f.record.name&&i.delete(f.record.name),f.children.forEach(o),f.alias.forEach(o))}}function a(){return t}function l(f){const d=OM(f,t);t.splice(d,0,f),f.record.name&&!Fu(f)&&i.set(f.record.name,f)}function c(f,d){let h,_={},v,m;if("name"in f&&f.name){if(h=i.get(f.name),!h)throw mr(1,{location:f});m=h.record.name,_=rt(Nu(d.params,h.keys.filter(S=>!S.optional).concat(h.parent?h.parent.keys.filter(S=>S.optional):[]).map(S=>S.name)),f.params&&Nu(f.params,h.keys.map(S=>S.name))),v=h.stringify(_)}else if(f.path!=null)v=f.path,h=t.find(S=>S.re.test(v)),h&&(_=h.parse(v),m=h.record.name);else{if(h=d.name?i.get(d.name):t.find(S=>S.re.test(d.path)),!h)throw mr(1,{location:f,currentLocation:d});m=h.record.name,_=rt({},d.params,f.params),v=h.stringify(_)}const p=[];let b=h;for(;b;)p.unshift(b.record),b=b.parent;return{name:m,path:v,params:_,matched:p,meta:FM(p)}}n.forEach(f=>s(f));function u(){t.length=0,i.clear()}return{addRoute:s,resolve:c,removeRoute:o,clearRoutes:u,getRoutes:a,getRecordMatcher:r}}function Nu(n,e){const t={};for(const i of e)i in n&&(t[i]=n[i]);return t}function UM(n){return{path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:void 0,beforeEnter:n.beforeEnter,props:NM(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}}}function NM(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const i in n.components)e[i]=typeof t=="object"?t[i]:t;return e}function Fu(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function FM(n){return n.reduce((e,t)=>rt(e,t.meta),{})}function Ou(n,e){const t={};for(const i in n)t[i]=i in e?e[i]:n[i];return t}function OM(n,e){let t=0,i=e.length;for(;t!==i;){const s=t+i>>1;qd(n,e[s])<0?i=s:t=s+1}const r=zM(n);return r&&(i=e.lastIndexOf(r,i-1)),i}function zM(n){let e=n;for(;e=e.parent;)if(Kd(e)&&qd(n,e)===0)return e}function Kd({record:n}){return!!(n.name||n.components&&Object.keys(n.components).length||n.redirect)}function BM(n){const e={};if(n===""||n==="?")return e;const i=(n[0]==="?"?n.slice(1):n).split("&");for(let r=0;r<i.length;++r){const s=i[r].replace(Bd," "),o=s.indexOf("="),a=Gr(o<0?s:s.slice(0,o)),l=o<0?null:Gr(s.slice(o+1));if(a in e){let c=e[a];sn(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function zu(n){let e="";for(let t in n){const i=n[t];if(t=oM(t),i==null){i!==void 0&&(e+=(e.length?"&":"")+t);continue}(sn(i)?i.map(s=>s&&Fa(s)):[i&&Fa(i)]).forEach(s=>{s!==void 0&&(e+=(e.length?"&":"")+t,s!=null&&(e+="="+s))})}return e}function HM(n){const e={};for(const t in n){const i=n[t];i!==void 0&&(e[t]=sn(i)?i.map(r=>r==null?null:""+r):i==null?i:""+i)}return e}const VM=Symbol(""),Bu=Symbol(""),hl=Symbol(""),pl=Symbol(""),za=Symbol("");function wr(){let n=[];function e(i){return n.push(i),()=>{const r=n.indexOf(i);r>-1&&n.splice(r,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function Yn(n,e,t,i,r,s=o=>o()){const o=i&&(i.enterCallbacks[r]=i.enterCallbacks[r]||[]);return()=>new Promise((a,l)=>{const c=d=>{d===!1?l(mr(4,{from:t,to:e})):d instanceof Error?l(d):TM(d)?l(mr(2,{from:e,to:d})):(o&&i.enterCallbacks[r]===o&&typeof d=="function"&&o.push(d),a())},u=s(()=>n.call(i&&i.instances[r],e,t,c));let f=Promise.resolve(u);n.length<3&&(f=f.then(c)),f.catch(d=>l(d))})}function pa(n,e,t,i,r=s=>s()){const s=[];for(const o of n)for(const a in o.components){let l=o.components[a];if(!(e!=="beforeRouteEnter"&&!o.instances[a]))if(GM(l)){const u=(l.__vccOpts||l)[e];u&&s.push(Yn(u,t,i,o,a,r))}else{let c=l();s.push(()=>c.then(u=>{if(!u)return Promise.reject(new Error(`Couldn't resolve component "${a}" at "${o.path}"`));const f=YS(u)?u.default:u;o.components[a]=f;const h=(f.__vccOpts||f)[e];return h&&Yn(h,t,i,o,a,r)()}))}}return s}function GM(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function Hu(n){const e=_n(hl),t=_n(pl),i=Qt(()=>{const l=nr(n.to);return e.resolve(l)}),r=Qt(()=>{const{matched:l}=i.value,{length:c}=l,u=l[c-1],f=t.matched;if(!u||!f.length)return-1;const d=f.findIndex(pr.bind(null,u));if(d>-1)return d;const h=Vu(l[c-2]);return c>1&&Vu(u)===h&&f[f.length-1].path!==h?f.findIndex(pr.bind(null,l[c-2])):d}),s=Qt(()=>r.value>-1&&qM(t.params,i.value.params)),o=Qt(()=>r.value>-1&&r.value===t.matched.length-1&&kd(t.params,i.value.params));function a(l={}){return XM(l)?e[nr(n.replace)?"replace":"push"](nr(n.to)).catch(Nr):Promise.resolve()}return{route:i,href:Qt(()=>i.value.href),isActive:s,isExactActive:o,navigate:a}}const kM=ao({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Hu,setup(n,{slots:e}){const t=no(Hu(n)),{options:i}=_n(hl),r=Qt(()=>({[Gu(n.activeClass,i.linkActiveClass,"router-link-active")]:t.isActive,[Gu(n.exactActiveClass,i.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const s=e.default&&e.default(t);return n.custom?s:sl("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:r.value},s)}}}),WM=kM;function XM(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function qM(n,e){for(const t in e){const i=e[t],r=n[t];if(typeof i=="string"){if(i!==r)return!1}else if(!sn(r)||r.length!==i.length||i.some((s,o)=>s!==r[o]))return!1}return!0}function Vu(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const Gu=(n,e,t)=>n??e??t,KM=ao({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const i=_n(za),r=Qt(()=>n.route||i.value),s=_n(Bu,0),o=Qt(()=>{let c=nr(s);const{matched:u}=r.value;let f;for(;(f=u[c])&&!f.components;)c++;return c}),a=Qt(()=>r.value.matched[o.value]);Ds(Bu,Qt(()=>o.value+1)),Ds(VM,a),Ds(za,r);const l=hn();return Us(()=>[l.value,a.value,n.name],([c,u,f],[d,h,_])=>{u&&(u.instances[f]=c,h&&h!==u&&c&&c===d&&(u.leaveGuards.size||(u.leaveGuards=h.leaveGuards),u.updateGuards.size||(u.updateGuards=h.updateGuards))),c&&u&&(!h||!pr(u,h)||!d)&&(u.enterCallbacks[f]||[]).forEach(v=>v(c))},{flush:"post"}),()=>{const c=r.value,u=n.name,f=a.value,d=f&&f.components[u];if(!d)return ku(t.default,{Component:d,route:c});const h=f.props[u],_=h?h===!0?c.params:typeof h=="function"?h(c):h:null,m=sl(d,rt({},_,e,{onVnodeUnmounted:p=>{p.component.isUnmounted&&(f.instances[u]=null)},ref:l}));return ku(t.default,{Component:m,route:c})||m}}});function ku(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const $M=KM;function YM(n){const e=DM(n.routes,n),t=n.parseQuery||BM,i=n.stringifyQuery||zu,r=n.history,s=wr(),o=wr(),a=wr(),l=zh(Xn);let c=Xn;Ji&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=fa.bind(null,N=>""+N),f=fa.bind(null,lM),d=fa.bind(null,Gr);function h(N,ae){let re,de;return Wd(N)?(re=e.getRecordMatcher(N),de=ae):de=N,e.addRoute(de,re)}function _(N){const ae=e.getRecordMatcher(N);ae&&e.removeRoute(ae)}function v(){return e.getRoutes().map(N=>N.record)}function m(N){return!!e.getRecordMatcher(N)}function p(N,ae){if(ae=rt({},ae||l.value),typeof N=="string"){const w=da(t,N,ae.path),U=e.resolve({path:w.path},ae),Y=r.createHref(w.fullPath);return rt(w,U,{params:d(U.params),hash:Gr(w.hash),redirectedFrom:void 0,href:Y})}let re;if(N.path!=null)re=rt({},N,{path:da(t,N.path,ae.path).path});else{const w=rt({},N.params);for(const U in w)w[U]==null&&delete w[U];re=rt({},N,{params:f(w)}),ae.params=f(ae.params)}const de=e.resolve(re,ae),L=N.hash||"";de.params=u(d(de.params));const we=fM(i,rt({},N,{hash:sM(L),path:de.path})),T=r.createHref(we);return rt({fullPath:we,hash:L,query:i===zu?HM(N.query):N.query||{}},de,{redirectedFrom:void 0,href:T})}function b(N){return typeof N=="string"?da(t,N,l.value.path):rt({},N)}function S(N,ae){if(c!==N)return mr(8,{from:ae,to:N})}function A(N){return P(N)}function z(N){return A(rt(b(N),{replace:!0}))}function R(N){const ae=N.matched[N.matched.length-1];if(ae&&ae.redirect){const{redirect:re}=ae;let de=typeof re=="function"?re(N):re;return typeof de=="string"&&(de=de.includes("?")||de.includes("#")?de=b(de):{path:de},de.params={}),rt({query:N.query,hash:N.hash,params:de.path!=null?{}:N.params},de)}}function P(N,ae){const re=c=p(N),de=l.value,L=N.state,we=N.force,T=N.replace===!0,w=R(re);if(w)return P(rt(b(w),{state:typeof w=="object"?rt({},L,w.state):L,force:we,replace:T}),ae||re);const U=re;U.redirectedFrom=ae;let Y;return!we&&dM(i,de,re)&&(Y=mr(16,{to:U,from:de}),ye(de,de,!0,!1)),(Y?Promise.resolve(Y):x(U,de)).catch(k=>bn(k)?bn(k,2)?k:Me(k):W(k,U,de)).then(k=>{if(k){if(bn(k,2))return P(rt({replace:T},b(k.to),{state:typeof k.to=="object"?rt({},L,k.to.state):L,force:we}),ae||U)}else k=O(U,de,!0,T,L);return I(U,de,k),k})}function G(N,ae){const re=S(N,ae);return re?Promise.reject(re):Promise.resolve()}function E(N){const ae=te.values().next().value;return ae&&typeof ae.runWithContext=="function"?ae.runWithContext(N):N()}function x(N,ae){let re;const[de,L,we]=jM(N,ae);re=pa(de.reverse(),"beforeRouteLeave",N,ae);for(const w of de)w.leaveGuards.forEach(U=>{re.push(Yn(U,N,ae))});const T=G.bind(null,N,ae);return re.push(T),ge(re).then(()=>{re=[];for(const w of s.list())re.push(Yn(w,N,ae));return re.push(T),ge(re)}).then(()=>{re=pa(L,"beforeRouteUpdate",N,ae);for(const w of L)w.updateGuards.forEach(U=>{re.push(Yn(U,N,ae))});return re.push(T),ge(re)}).then(()=>{re=[];for(const w of we)if(w.beforeEnter)if(sn(w.beforeEnter))for(const U of w.beforeEnter)re.push(Yn(U,N,ae));else re.push(Yn(w.beforeEnter,N,ae));return re.push(T),ge(re)}).then(()=>(N.matched.forEach(w=>w.enterCallbacks={}),re=pa(we,"beforeRouteEnter",N,ae,E),re.push(T),ge(re))).then(()=>{re=[];for(const w of o.list())re.push(Yn(w,N,ae));return re.push(T),ge(re)}).catch(w=>bn(w,8)?w:Promise.reject(w))}function I(N,ae,re){a.list().forEach(de=>E(()=>de(N,ae,re)))}function O(N,ae,re,de,L){const we=S(N,ae);if(we)return we;const T=ae===Xn,w=Ji?history.state:{};re&&(de||T?r.replace(N.fullPath,rt({scroll:T&&w&&w.scroll},L)):r.push(N.fullPath,L)),l.value=N,ye(N,ae,re,T),Me()}let V;function ee(){V||(V=r.listen((N,ae,re)=>{if(!he.listening)return;const de=p(N),L=R(de);if(L){P(rt(L,{replace:!0}),de).catch(Nr);return}c=de;const we=l.value;Ji&&MM(Lu(we.fullPath,re.delta),xM()),x(de,we).catch(T=>bn(T,12)?T:bn(T,2)?(P(T.to,de).then(w=>{bn(w,20)&&!re.delta&&re.type===kr.pop&&r.go(-1,!1)}).catch(Nr),Promise.reject()):(re.delta&&r.go(-re.delta,!1),W(T,de,we))).then(T=>{T=T||O(de,we,!1),T&&(re.delta&&!bn(T,8)?r.go(-re.delta,!1):re.type===kr.pop&&bn(T,20)&&r.go(-1,!1)),I(de,we,T)}).catch(Nr)}))}let ne=wr(),Z=wr(),J;function W(N,ae,re){Me(N);const de=Z.list();return de.length?de.forEach(L=>L(N,ae,re)):console.error(N),Promise.reject(N)}function xe(){return J&&l.value!==Xn?Promise.resolve():new Promise((N,ae)=>{ne.add([N,ae])})}function Me(N){return J||(J=!N,ee(),ne.list().forEach(([ae,re])=>N?re(N):ae()),ne.reset()),N}function ye(N,ae,re,de){const{scrollBehavior:L}=n;if(!Ji||!L)return Promise.resolve();const we=!re&&yM(Lu(N.fullPath,0))||(de||!re)&&history.state&&history.state.scroll||null;return xf().then(()=>L(N,ae,we)).then(T=>T&&SM(T)).catch(T=>W(T,N,ae))}const Le=N=>r.go(N);let We;const te=new Set,he={currentRoute:l,listening:!0,addRoute:h,removeRoute:_,clearRoutes:e.clearRoutes,hasRoute:m,getRoutes:v,resolve:p,options:n,push:A,replace:z,go:Le,back:()=>Le(-1),forward:()=>Le(1),beforeEach:s.add,beforeResolve:o.add,afterEach:a.add,onError:Z.add,isReady:xe,install(N){const ae=this;N.component("RouterLink",WM),N.component("RouterView",$M),N.config.globalProperties.$router=ae,Object.defineProperty(N.config.globalProperties,"$route",{enumerable:!0,get:()=>nr(l)}),Ji&&!We&&l.value===Xn&&(We=!0,A(r.location).catch(L=>{}));const re={};for(const L in Xn)Object.defineProperty(re,L,{get:()=>l.value[L],enumerable:!0});N.provide(hl,ae),N.provide(pl,ff(re)),N.provide(za,l);const de=N.unmount;te.add(N),N.unmount=function(){te.delete(N),te.size<1&&(c=Xn,V&&V(),V=null,l.value=Xn,We=!1,J=!1),de()}}};function ge(N){return N.reduce((ae,re)=>ae.then(()=>E(re)),Promise.resolve())}return he}function jM(n,e){const t=[],i=[],r=[],s=Math.max(e.matched.length,n.matched.length);for(let o=0;o<s;o++){const a=e.matched[o];a&&(n.matched.find(c=>pr(c,a))?i.push(a):t.push(a));const l=n.matched[o];l&&(e.matched.find(c=>pr(c,l))||r.push(l))}return[t,i,r]}function ZM(n){return _n(pl)}const JM=n=>(Tf("data-v-e6bcfac8"),n=n(),bf(),n),QM=JM(()=>ke("header",null,[ke("h1",{class:"monumentextended-black"},[ke("span",null,"Krystian"),ke("span",{class:Jn("subtitle monumentextended-black")},"[Designer_and_Developer]"),ke("span",null,"Jasionek")])],-1)),ey=[QM],ty=ao({__name:"Home",setup(n){const e=hn({transform:"rotateY(0deg) rotateX(0deg)",transition:"transform 0.1s"});let t=0;const i=(s,o)=>{e.value={transform:`rotateY(${s}deg) rotateX(${o}deg)`,transition:"transform 0.1s"}};function r(s){const o=(window.innerWidth/2-s.clientX)/50,a=(window.innerHeight/2-s.clientY)/50;t&&cancelAnimationFrame(t),t=requestAnimationFrame(()=>{i(o,a)})}return Qa(()=>{window.addEventListener("mousemove",r)}),el(()=>{window.removeEventListener("mousemove",r),t&&cancelAnimationFrame(t)}),(s,o)=>(Jt(),un("article",null,ey))}}),Sr=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},ny=Sr(ty,[["__scopeId","data-v-e6bcfac8"]]),iy="/portfolio/assets/cv-morda-CKzvgHz1.png",ry={},sy=jf('<header data-v-63158464><img src="'+iy+'" data-v-63158464><h2 data-v-63158464>Hi, Krystian here ;)</h2></header><p data-v-63158464>I profoundly believe that beautiful design and good design are the same thing. As a designer and developer I strive to create the most visually pleasing and ergonomic interfaces possible.</p><p data-v-63158464>For web development my preferred tools are <a href="https://vuejs.org/" data-v-63158464>Vue.js</a> and <a href="https://sass-lang.com/" data-v-63158464>Sass</a>. Most of my recent projects have been built using these technologies. I&#39;m also experienced with <a href="https://react.dev/" data-v-63158464>React</a> and <a href="https://tailwindcss.com/" data-v-63158464>TailwindCSS</a>. </p><p data-v-63158464>I&#39;m the founder and developer of a small indie game studio called Kiki/Bouba. Our common belief is that games can be a form of art, and we aim to create experiences that are both emotionally engaging and provide satisfying gameplay. We strive to elevate user experience through engaging, aesthetic designs and a strong focus on ergonomics and functionality. </p>',4),oy=[sy];function ay(n,e,t,i,r,s){return Jt(),un("article",null,oy)}const $d=Sr(ry,[["render",ay],["__scopeId","data-v-63158464"]]),ly={},cy=jf('<header data-v-2f22cdb5><h2 data-v-2f22cdb5>If you want to have a talk with me or take a look at my projects, feel free to reach out on these platforms:</h2></header><address data-v-2f22cdb5><div class="socials" data-v-2f22cdb5><a href="mailto:krystian.jasionek@protonmail.com" data-v-2f22cdb5><p data-v-2f22cdb5><i class="fa-regular fa-envelope" data-v-2f22cdb5></i> krystian.jasionek@protonmail.com </p></a><a href="https://github.com/Sztakler" target="_blank" data-v-2f22cdb5><p data-v-2f22cdb5><i class="fab fa-github" data-v-2f22cdb5></i> Metarth</p></a></div><footer data-v-2f22cdb5><h2 data-v-2f22cdb5>I currently live in:</h2><a href="https://www.openstreetmap.org/#map=12/51.1264/16.9488" target="_blank" data-v-2f22cdb5><p data-v-2f22cdb5><i class="fa-regular fa-map" data-v-2f22cdb5></i> Wrocław, Poland</p></a></footer></address>',2),uy=[cy];function fy(n,e,t,i,r,s){return Jt(),un("article",null,uy)}const Yd=Sr(ly,[["render",fy],["__scopeId","data-v-2f22cdb5"]]),dy=["onClick"],hy={class:"project-header"},py={class:"project-year"},my={class:"project-title"},gy={class:"project-category"},_y={key:0,class:"collapsible-span"},vy=["href"],xy={class:"media"},Sy=["src"],My="./assets/videos/",yy={__name:"Projects",setup(n){const e=hn(!1);hn("vagabondoro.jpg");const t=["ale-jazda","vagabondoro","objviewer"],i=hn({"ale-jazda":{id:0,media:"alejazda.mp4",github:"https://github.com/Sztakler/driver-license-uwr",year:"2023",category:"Web Development",title:"Ale Jazda!",description:["A friend and I once discussed apps for preparing for the driver's license exam. Most of them seemed outdated, offered little, and worst of all, required payment. We both agreed that it didn't have to be this way. Seeking a solution, we enlisted the help of a friend studying Graphic Design. Together, we set out to create something fresh, modern, and completely free for everyone.","Our collaboration resulted in a sleek, user-friendly app featuring a training mode, a realistic simulation of the theoretical exam, a comprehensive textbook, and a user profile to track progress and revisit challenging questions. This project also served as the centerpiece of my diploma thesis, reflecting our dedication to enhancing the user experience."],visible:!1},vagabondoro:{id:1,media:"vagabondoro.webm",github:"https://github.com/Sztakler/vagabondoro-timer",year:"2024",category:"Web Design & Development",title:"Vagabondoro Timer",description:[`Seeking a solution for managing my work time and tasks, I developed an application to refine my skills in TypeScript and Vue. Inspired by the minimalist style of a Vagabond manga panel and the serene Kanagawa theme of Neovim, the app aims to minimize distractions and boost productivity.
...
`,"Designed with mobile usability in mind, the app ensures a responsive experience across devices."],visible:!1},objviewer:{id:2,media:"objviewer.mp4",github:"https://github.com/Sztakler/opengl-objectviewer",year:"2021",category:"OpenGL & C++",title:"Objviewer",description:["During my time at the University of Wroclaw studying computer science, I enrolled in a computer graphics course that significantly expanded my technical skill set. I gained foundational knowledge in GPU pipelines and OpenGL, as well as the principles of computer representation of models, textures, and lighting. Additionally, I delved into the mathematics behind projections, rotations, cameras, and reflections.","As part of the course, I completed three programming projects that allowed me to apply what I had learned. One notable project was the development of a program for displaying 3D models saved in the .obj format. This program showcased my ability to render textures, including procedural ones, and supported various lighting and reflection models. It also featured an arcball camera, enabling users to interactively observe the model from different angles."],visible:!1},default:{id:3,media:"",github:"",year:"",category:"",title:"",description:"",visible:!1}}),r=hn(i.value.default);function s(f){r.value===i.value[f]?(r.value.visible=!r.value.visible,e.value=r.value.visible):(r.value.visible=!1,r.value=i.value[f],r.value.visible=!0,e.value=!0),console.log(e.value)}hn(!1);function o(f){s(f)}function a(){return My+r.value.media}function l(f){return console.log("aa",f,r.value.id,e.value,r.value.id===f,!e.value||r.value.id===f),!e.value||r.value.id===f}function c(f){f.style.height="0",setTimeout(()=>{f.style.height=f.scrollHeight+"px"})}function u(f){f.style.height=f.scrollHeight+"px",setTimeout(()=>{f.style.height="0"})}return(f,d)=>(Jt(),un("article",null,[ke("div",{class:Jn(["projects",e.value?"single-project-display":"all-projects-display"])},[(Jt(),un(Ot,null,Ll(t,(h,_)=>ke("button",{key:_,class:"project"},[l(_)?(Jt(),un("div",{key:0,class:"project-content",onClick:v=>o(h)},[ke("div",hy,[ke("span",py,es(i.value[h].year),1),ke("span",my,es(i.value[h].title),1)]),ke("span",gy,es(i.value[h].category),1),dt(ol,{class:"description",name:"description",onEnter:c,onLeave:u},{default:Af(()=>[i.value[h].visible?(Jt(),un("span",_y,[(Jt(!0),un(Ot,null,Ll(i.value[h].description,(v,m)=>(Jt(),un("p",{key:m},es(v),1))),128)),ke("a",{class:"github-link",href:i.value[h].github,target:"_blank"},"> See on Github",8,vy)])):kl("",!0)]),_:2},1024)],8,dy)):kl("",!0)])),64))],2),ke("aside",xy,[ke("video",{src:a(),autoplay:"",loop:"",preload:"auto"},null,8,Sy)])]))}},jd=Sr(yy,[["__scopeId","data-v-71dc3b37"]]),jr=n=>(Tf("data-v-4d4ae535"),n=n(),bf(),n),Ey=jr(()=>ke("a",{class:"hidden",id:"home"},"K_J_",-1)),Ty=jr(()=>ke("a",{class:"hidden",id:"about-me"},"About_me_",-1)),by=jr(()=>ke("a",{class:"hidden",id:"projects"},"Projects_",-1)),Ay=jr(()=>ke("a",{class:"hidden",id:"contact"},"Contact_",-1)),wy={class:"red-hat-display-semibold"},Ry={class:"left"},Cy={class:"right"},Py={id:"home",class:"bg-1"},Ly={id:"about-me",class:"bg-2"},Iy={id:"projects",class:"bg-3"},Dy={id:"contact",class:"bg-4"},Uy=jr(()=>ke("footer",{class:"red-hat-display-semibold"},[ke("li",{class:"socials"},[ke("a",{href:"https://github.com/Sztakler",target:"_blank"}," Github_")]),Yf(" || "),ke("li",null,[ke("a",{href:"mailto:krystian.jasionek@protonmail.com"},"E-mail_")])],-1)),Ny=ao({__name:"App",setup(n){let e,t,i,r,s,o,a;const l=ZM(),c=hn("home"),u=hn(["home","about-me","projects","contact"]),f=hn(0),d=new OS;function h(){return`
        varying vec3 vUv;
  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}v();function v(){e=new kt(70,window.innerWidth/window.innerHeight,.1,100),e.position.z=2,t=new US;let A={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:d.getDelta()}};a=new vr(10,10,1),o=new Kt({uniforms:A,fragmentShader:_(),vertexShader:h()}),s=new rn(a,o),t.add(s),i=new DS({antialias:!0}),i.setPixelRatio(window.devicePixelRatio),i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(b),document.body.appendChild(i.domElement).id="glitch",r=new XS(i);const z=new qS(t,e);r.addPass(z);const R=new $S;r.addPass(R),window.addEventListener("resize",m)}function m(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}let p=!0;function b(){d.update(),o.uniforms.time.value=d.getElapsed(),l.path==="/"?(p=!0,r.render()):p&&(i.clear(),p=!1)}function S(A){c.value=A}return window.addEventListener("wheel",A=>{let z="home";A.deltaY<0&&f.value>0?f.value--:A.deltaY>0&&f.value<u.value.length-1&&f.value++,z=u.value[f.value],S(z),document.getElementById(z+"-link").click()}),(A,z)=>(Jt(),un(Ot,null,[Ey,Ty,by,Ay,ke("nav",wy,[ke("ul",null,[ke("div",Ry,[ke("li",null,[ke("a",{id:"home-link",class:Jn({active:c.value==="home"}),onClick:z[0]||(z[0]=R=>S("home")),href:"#home"},"K_J_",2)])]),ke("div",Cy,[ke("li",null,[ke("a",{id:"projects-link",class:Jn({active:c.value==="projects"}),onClick:z[1]||(z[1]=R=>S("projects")),href:"#projects"},"Projects_",2)]),ke("li",null,[ke("a",{id:"about-me-link",class:Jn({active:c.value==="about-me"}),onClick:z[2]||(z[2]=R=>S("about-me")),href:"#about-me"},"About_Me_",2)])])])]),ke("section",Py,[dt(ny)]),ke("section",Ly,[dt($d)]),ke("section",Iy,[dt(jd)]),ke("section",Dy,[dt(Yd)]),Uy],64))}}),Fy=Sr(Ny,[["__scopeId","data-v-4d4ae535"]]),Oy={};function zy(n,e,t,i,r,s){return null}const By=Sr(Oy,[["render",zy]]),Hy=[{path:"/",component:By},{path:"/about-me",component:$d},{path:"/projects",component:jd},{path:"/contact",component:Yd}],Vy=YM({history:EM(),routes:Hy});ym(Fy).use(Vy).mount("#app");

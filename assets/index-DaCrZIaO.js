...
`].filter(gr).join(`
`)),o=va(o),o=Yc(o,t),o=$c(o,t),a=va(a),a=Yc(a,t),a=$c(a,t),o=jc(o),a=jc(a),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}v();function v(){e=new Ht(70,window.innerWidth/window.innerHeight,.1,100),e.position.z=2,t=new $x;let A={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:d.getDelta()}};a=new sr(10,10,1),o=new kt({uniforms:A,fragmentShader:_(),vertexShader:p()}),s=new Zt(a,o),t.add(s),i=new Yx({antialias:!0}),i.setPixelRatio(window.devicePixelRatio),i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(b),document.body.appendChild(i.domElement).id="glitch",r=new oS(i);const O=new aS(t,e);r.addPass(O);const C=new cS;r.addPass(C),window.addEventListener("resize",m)}function m(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}let h=!0;function b(){d.update(),o.uniforms.time.value=d.getElapsed(),l.path==="/"?(h=!0,r.render()):h&&(i.clear(),h=!1)}function x(A){c.value=A}return window.addEventListener("wheel",A=>{let O="home";A.deltaY<0&&f.value>0?f.value--:A.deltaY>0&&f.value<u.value.length-1&&f.value++,O=u.value[f.value],x(O),document.getElementById(O+"-link").click()}),(A,O)=>(Ur(),Dr(sn,null,[IM,UM,DM,NM,nt("header",null,[nt("nav",FM,[nt("ul",null,[nt("li",null,[nt("a",{id:"home-link",class:kn({active:c.value==="home"}),onClick:O[0]||(O[0]=C=>x("home")),href:"#home"},"Home",2)]),nt("li",null,[nt("a",{id:"about-me-link",class:kn({active:c.value==="about-me"}),onClick:O[1]||(O[1]=C=>x("about-me")),href:"#about-me"},"About Me",2)]),nt("li",null,[nt("a",{id:"projects-link",class:kn({active:c.value==="projects"}),onClick:O[2]||(O[2]=C=>x("projects")),href:"#projects"},"Projects",2)]),nt("li",null,[nt("a",{id:"contact-link",class:kn({active:c.value==="contact"}),onClick:O[3]||(O[3]=C=>x("contact")),href:"#contact"},"Contact",2)])])])]),nt("section",OM,[yt(vM)]),nt("section",zM,[yt(fd)]),nt("section",BM,[yt(hd)]),nt("section",HM,[yt(dd)])],64))}}),GM=ar(VM,[["__scopeId","data-v-f2b5e684"]]),kM={};function WM(n,e,t,i,r,s){return null}const XM=ar(kM,[["render",WM]]),qM=[{path:"/",component:XM},{path:"/about-me",component:fd},{path:"/projects",component:hd},{path:"/contact",component:dd}],KM=uM({history:zS(),routes:qM});Op(GM).use(KM).mount("#app");

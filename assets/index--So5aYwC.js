  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}v();function v(){e=new Ht(70,window.innerWidth/window.innerHeight,.1,100),e.position.z=2,t=new Jx;let A={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:d.getDelta()}};a=new ar(10,10,1),o=new kt({uniforms:A,fragmentShader:_(),vertexShader:p()}),s=new Zt(a,o),t.add(s),i=new Zx({antialias:!0}),i.setPixelRatio(window.devicePixelRatio),i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(b),document.body.appendChild(i.domElement).id="glitch",r=new cS(i);const z=new uS(t,e);r.addPass(z);const C=new dS;r.addPass(C),window.addEventListener("resize",m)}function m(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}let h=!0;function b(){d.update(),o.uniforms.time.value=d.getElapsed(),l.path==="/"?(h=!0,r.render()):h&&(i.clear(),h=!1)}function S(A){c.value=A}return window.addEventListener("wheel",A=>{let z="home";A.deltaY<0&&f.value>0?f.value--:A.deltaY>0&&f.value<u.value.length-1&&f.value++,z=u.value[f.value],S(z),document.getElementById(z+"-link").click()}),(A,z)=>(Nr(),Fr(sn,null,[KM,$M,YM,jM,Fe("header",null,[Fe("nav",ZM,[Fe("ul",null,[Fe("div",JM,[Fe("li",null,[Fe("a",{id:"home-link",class:Si({active:c.value==="home"}),onClick:z[0]||(z[0]=C=>S("home")),href:"#home"},"Home_",2)])]),Fe("div",QM,[Fe("li",null,[Fe("a",{id:"about-me-link",class:Si({active:c.value==="about-me"}),onClick:z[1]||(z[1]=C=>S("about-me")),href:"#about-me"},"About_Me_",2)]),Fe("li",null,[Fe("a",{id:"projects-link",class:Si({active:c.value==="projects"}),onClick:z[2]||(z[2]=C=>S("projects")),href:"#projects"},"Projects_",2)])])])])]),Fe("section",ey,[yt(MM)]),Fe("section",ty,[yt(gd)]),Fe("section",ny,[yt(vd)]),Fe("section",iy,[yt(_d)]),ry],64))}}),oy=cr(sy,[["__scopeId","data-v-ea825c8b"]]),ay={};function ly(n,e,t,i,r,s){return null}const cy=cr(ay,[["render",ly]]),uy=[{path:"/",component:cy},{path:"/about-me",component:gd},{path:"/projects",component:vd},{path:"/contact",component:_d}],fy=hM({history:VS(),routes:uy});Hp(oy).use(fy).mount("#app");

...
`].filter(vr).join(`
`)),o=xa(o),o=jc(o,t),o=Zc(o,t),a=xa(a),a=jc(a,t),a=Zc(a,t),o=Jc(o),a=Jc(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+h);const y=T+m+o,A=T+h+a,O=$c(r,r.VERTEX_SHADER,y),R=$c(r,r.FRAGMENT_SHADER,A);r.attachShader(v,O),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function L(U){if(n.debug.checkShaderErrors){const Q=r.getProgramInfoLog(v).trim(),$=r.getShaderInfoLog(O).trim(),se=r.getShaderInfoLog(R).trim();let ie=!0,j=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(ie=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,O,R);else{const Z=Yc(r,O,"vertex"),G=Yc(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}v();function v(){e=new Ht(70,window.innerWidth/window.innerHeight,.1,100),e.position.z=2,t=new Zx;let A={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:d.getDelta()}};a=new ar(10,10,1),o=new kt({uniforms:A,fragmentShader:_(),vertexShader:p()}),s=new Zt(a,o),t.add(s),i=new jx({antialias:!0}),i.setPixelRatio(window.devicePixelRatio),i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(T),document.body.appendChild(i.domElement).id="glitch",r=new lS(i);const O=new cS(t,e);r.addPass(O);const R=new fS;r.addPass(R),window.addEventListener("resize",m)}function m(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}let h=!0;function T(){d.update(),o.uniforms.time.value=d.getElapsed(),l.path==="/"?(h=!0,r.render()):h&&(i.clear(),h=!1)}function y(A){c.value=A}return window.addEventListener("wheel",A=>{let O="home";A.deltaY<0&&f.value>0?f.value--:A.deltaY>0&&f.value<u.value.length-1&&f.value++,O=u.value[f.value],y(O),document.getElementById(O+"-link").click()}),(A,O)=>(Nr(),Fr(sn,null,[qM,KM,$M,YM,He("header",null,[He("nav",jM,[He("ul",null,[He("li",null,[He("a",{id:"home-link",class:Wn({active:c.value==="home"}),onClick:O[0]||(O[0]=R=>y("home")),href:"#home"},"Home",2)]),He("li",null,[He("a",{id:"about-me-link",class:Wn({active:c.value==="about-me"}),onClick:O[1]||(O[1]=R=>y("about-me")),href:"#about-me"},"About Me",2)]),He("li",null,[He("a",{id:"projects-link",class:Wn({active:c.value==="projects"}),onClick:O[2]||(O[2]=R=>y("projects")),href:"#projects"},"Projects",2)]),He("li",null,[He("a",{id:"contact-link",class:Wn({active:c.value==="contact"}),onClick:O[3]||(O[3]=R=>y("contact")),href:"#contact"},"Contact",2)])])])]),He("section",ZM,[yt(SM)]),He("section",JM,[yt(hd)]),He("section",QM,[yt(md)]),He("section",ey,[yt(pd)])],64))}}),ny=cr(ty,[["__scopeId","data-v-f0131b64"]]),iy={};function ry(n,e,t,i,r,s){return null}const sy=cr(iy,[["render",ry]]),oy=[{path:"/",component:sy},{path:"/about-me",component:hd},{path:"/projects",component:md},{path:"/contact",component:pd}],ay=dM({history:HS(),routes:oy});Bp(ny).use(ay).mount("#app");

  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}v();function v(){e=new Ht(70,window.innerWidth/window.innerHeight,.1,100),e.position.z=2,t=new Jx;let A={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:d.getDelta()}};a=new ar(10,10,1),o=new kt({uniforms:A,fragmentShader:_(),vertexShader:p()}),s=new Zt(a,o),t.add(s),i=new Zx({antialias:!0}),i.setPixelRatio(window.devicePixelRatio),i.setSize(window.innerWidth,window.innerHeight),i.setAnimationLoop(b),document.body.appendChild(i.domElement).id="glitch",r=new cS(i);const O=new uS(t,e);r.addPass(O);const C=new dS;r.addPass(C),window.addEventListener("resize",m)}function m(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}let h=!0;function b(){d.update(),o.uniforms.time.value=d.getElapsed(),l.path==="/"?(h=!0,r.render()):h&&(i.clear(),h=!1)}function x(A){c.value=A}return window.addEventListener("wheel",A=>{let O="home";A.deltaY<0&&f.value>0?f.value--:A.deltaY>0&&f.value<u.value.length-1&&f.value++,O=u.value[f.value],x(O),document.getElementById(O+"-link").click()}),(A,O)=>(Nr(),Fr(sn,null,[KM,$M,YM,jM,Ne("header",null,[Ne("nav",ZM,[Ne("ul",null,[Ne("div",JM,[Ne("li",null,[Ne("a",{id:"home-link",class:Wn({active:c.value==="home"}),onClick:O[0]||(O[0]=C=>x("home")),href:"#home"},"Home_",2)])]),QM,Ne("div",ey,[Ne("li",null,[Ne("a",{id:"about-me-link",class:Wn({active:c.value==="about-me"}),onClick:O[1]||(O[1]=C=>x("about-me")),href:"#about-me"},"About_Me_",2)]),Ne("li",null,[Ne("a",{id:"projects-link",class:Wn({active:c.value==="projects"}),onClick:O[2]||(O[2]=C=>x("projects")),href:"#projects"},"Projects_",2)]),Ne("li",null,[Ne("a",{id:"contact-link",class:Wn({active:c.value==="contact"}),onClick:O[3]||(O[3]=C=>x("contact")),href:"#contact"},"Contact_",2)])])])])]),Ne("section",ty,[yt(MM)]),Ne("section",ny,[yt(gd)]),Ne("section",iy,[yt(vd)]),Ne("section",ry,[yt(_d)])],64))}}),oy=cr(sy,[["__scopeId","data-v-6e685c17"]]),ay={};function ly(n,e,t,i,r,s){return null}const cy=cr(ay,[["render",ly]]),uy=[{path:"/",component:cy},{path:"/about-me",component:gd},{path:"/projects",component:vd},{path:"/contact",component:_d}],fy=hM({history:VS(),routes:uy});Hp(oy).use(fy).mount("#app");

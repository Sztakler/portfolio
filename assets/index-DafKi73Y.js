...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function hc(){return new Bt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Da(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function pc(){return new Bt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Da(),fragmentShader:`
	...
	`}function i_(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===oa||l===aa,u=l===ji||l===Zi;if(c||u){let f=e.get(a);const d=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new fc(n)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),f.texture;if(f!==void 0)return f.texture;{const p=a.image;return c&&p&&p.height>0||u&&p&&r(p)?(t===null&&(t=new fc(n)),f=c?t.fromEquirectangular(a):t.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),a.addEventListener("dispose",s),f.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function r_(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Ku("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function s_(n,e,t,i){const r={},s=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);for(const _ in d.morphAttributes){const v=d.morphAttributes[_];for(let m=0,h=v.length;m<h;m++)e.remove(v[m])}d.removeEventListener("dispose",o),delete r[d.id];const p=s.get(d);p&&(e.remove(p),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(f,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const _ in d)e.update(d[_],n.ARRAY_BUFFER);const p=f.morphAttributes;for(const _ in p){const v=p[_];for(let m=0,h=v.length;m<h;m++)e.update(v[m],n.ARRAY_BUFFER)}}function c(f){const d=[],p=f.index,_=f.attributes.position;let v=0;if(p!==null){const T=p.array;v=p.version;for(let y=0,A=T.length;y<A;y+=3){const V=T[y+0],C=T[y+1],L=T[y+2];d.push(V,C,C,L,L,V)}}else if(_!==void 0){const T=_.array;v=_.version;for(let y=0,A=T.length/3-1;y<A;y+=3){const V=y+0,C=y+1,L=y+2;d.push(V,C,C,L,L,V)}}else return;const m=new(qu(d)?ef:Qu)(d,1);m.version=v;const h=s.get(f);h&&e.remove(h),s.set(f,m)}function u(f){const d=s.get(f);if(d){const p=f.index;p!==null&&d.version<p.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function o_(n,e,t){let i;function r(d){i=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,p){n.drawElements(i,p,s,d*o),t.update(p,i,1)}function c(d,p,_){_!==0&&(n.drawElementsInstanced(i,p,s,d*o,_),t.update(p,i,_))}function u(d,p,_){if(_===0)return;const v=e.get("WEBGL_multi_draw");if(v===null)for(let m=0;m<_;m++)this.render(d[m]/o,p[m]);else{v.multiDrawElementsWEBGL(i,p,0,s,d,0,_);let m=0;for(let h=0;h<_;h++)m+=p[h];t.update(m,i,1)}}function f(d,p,_,v){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let h=0;h<d.length;h++)c(d[h]/o,p[h],v[h]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,d,0,v,0,_);let h=0;for(let T=0;T<_;T++)h+=p[T];for(let T=0;T<v.length;T++)t.update(h,i,v[T])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function a_(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function l_(n,e,t){const i=new WeakMap,r=new _t;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let d=i.get(a);if(d===void 0||d.count!==f){let M=function(){H.dispose(),i.delete(a),a.removeEventListener("dispose",M)};var p=M;d!==void 0&&d.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,h=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],y=a.morphAttributes.color||[];let A=0;_===!0&&(A=1),v===!0&&(A=2),m===!0&&(A=3);let V=a.attributes.position.count*A,C=1;V>e.maxTextureSize&&(C=Math.ceil(V/e.maxTextureSize),V=e.maxTextureSize);const L=new Float32Array(V*C*4*f),H=new $u(L,V,C,f);H.type=bn,H.needsUpdate=!0;const b=A*4;for(let U=0;U<f;U++){const Q=h[U],Y=T[U],se=y[U],ie=V*C*4*U;for(let j=0;j<Q.count;j++){const Z=j*b;_===!0&&(r.fromBufferAttribute(Q,j),L[ie+Z+0]=r.x,L[ie+Z+1]=r.y,L[ie+Z+2]=r.z,L[ie+Z+3]=0),v===!0&&(r.fromBufferAttribute(Y,j),L[ie+Z+4]=r.x,L[ie+Z+5]=r.y,L[ie+Z+6]=r.z,L[ie+Z+7]=0),m===!0&&(r.fromBufferAttribute(se,j),L[ie+Z+8]=r.x,L[ie+Z+9]=r.y,L[ie+Z+10]=r.z,L[ie+Z+11]=se.itemSize===4?r.w:1)}}d={count:f,texture:H,size:new qe(V,C)},i.set(a,d),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const v=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(n,"morphTargetBaseInfluence",v),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:s}}function c_(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,f=e.get(l,u);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class lf extends Rt{constructor(e,t,i,r,s,o,a,l,c,u=Xi){if(u!==Xi&&u!==er)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Xi&&(i=Ji),i===void 0&&u===er&&(i=Qi),super(null,r,s,o,a,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Pt,this.minFilter=l!==void 0?l:Pt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const cf=new Rt,uf=new lf(1,1);uf.compareFunction=Xu;const ff=new $u,df=new $h,hf=new rf,mc=[],gc=[],_c=new Float32Array(16),vc=new Float32Array(9),xc=new Float32Array(4);function lr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=mc[r];if(s===void 0&&(s=new Float32Array(r),mc[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function ut(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ft(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function js(n,e){let t=gc[e];t===void 0&&(t=new Int32Array(e),gc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function u_(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function f_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;n.uniform2fv(this.addr,e),ft(t,e)}}function d_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ut(t,e))return;n.uniform3fv(this.addr,e),ft(t,e)}}function h_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;n.uniform4fv(this.addr,e),ft(t,e)}}function p_(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ut(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ft(t,e)}else{if(ut(t,i))return;xc.set(i),n.uniformMatrix2fv(this.addr,!1,xc),ft(t,i)}}function m_(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ut(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ft(t,e)}else{if(ut(t,i))return;vc.set(i),n.uniformMatrix3fv(this.addr,!1,vc),ft(t,i)}}function g_(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ut(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ft(t,e)}else{if(ut(t,i))return;_c.set(i),n.uniformMatrix4fv(this.addr,!1,_c),ft(t,i)}}function __(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function v_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;n.uniform2iv(this.addr,e),ft(t,e)}}function x_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ut(t,e))return;n.uniform3iv(this.addr,e),ft(t,e)}}function S_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;n.uniform4iv(this.addr,e),ft(t,e)}}function M_(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function y_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;n.uniform2uiv(this.addr,e),ft(t,e)}}function E_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ut(t,e))return;n.uniform3uiv(this.addr,e),ft(t,e)}}function T_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;n.uniform4uiv(this.addr,e),ft(t,e)}}function b_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);const s=this.type===n.SAMPLER_2D_SHADOW?uf:cf;t.setTexture2D(e||s,r)}function A_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||df,r)}function w_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||hf,r)}function R_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||ff,r)}function C_(n){switch(n){case 5126:return u_;case 35664:return f_;case 35665:return d_;case 35666:return h_;case 35674:return p_;case 35675:return m_;case 35676:return g_;case 5124:case 35670:return __;case 35667:case 35671:return v_;case 35668:case 35672:return x_;case 35669:case 35673:return S_;case 5125:return M_;case 36294:return y_;case 36295:return E_;case 36296:return T_;case 35678:case 36198:case 36298:case 36306:case 35682:return b_;case 35679:case 36299:case 36307:return A_;case 35680:case 36300:case 36308:case 36293:return w_;case 36289:case 36303:case 36311:case 36292:return R_}}function P_(n,e){n.uniform1fv(this.addr,e)}function L_(n,e){const t=lr(e,this.size,2);n.uniform2fv(this.addr,t)}function D_(n,e){const t=lr(e,this.size,3);n.uniform3fv(this.addr,t)}function U_(n,e){const t=lr(e,this.size,4);n.uniform4fv(this.addr,t)}function I_(n,e){const t=lr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function N_(n,e){const t=lr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function F_(n,e){const t=lr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function O_(n,e){n.uniform1iv(this.addr,e)}function z_(n,e){n.uniform2iv(this.addr,e)}function B_(n,e){n.uniform3iv(this.addr,e)}function H_(n,e){n.uniform4iv(this.addr,e)}function V_(n,e){n.uniform1uiv(this.addr,e)}function G_(n,e){n.uniform2uiv(this.addr,e)}function k_(n,e){n.uniform3uiv(this.addr,e)}function W_(n,e){n.uniform4uiv(this.addr,e)}function X_(n,e,t){const i=this.cache,r=e.length,s=js(t,r);ut(i,s)||(n.uniform1iv(this.addr,s),ft(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||cf,s[o])}function q_(n,e,t){const i=this.cache,r=e.length,s=js(t,r);ut(i,s)||(n.uniform1iv(this.addr,s),ft(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||df,s[o])}function K_(n,e,t){const i=this.cache,r=e.length,s=js(t,r);ut(i,s)||(n.uniform1iv(this.addr,s),ft(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||hf,s[o])}function Y_(n,e,t){const i=this.cache,r=e.length,s=js(t,r);ut(i,s)||(n.uniform1iv(this.addr,s),ft(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||ff,s[o])}function $_(n){switch(n){case 5126:return P_;case 35664:return L_;case 35665:return D_;case 35666:return U_;case 35674:return I_;case 35675:return N_;case 35676:return F_;case 5124:case 35670:return O_;case 35667:case 35671:return z_;case 35668:case 35672:return B_;case 35669:case 35673:return H_;case 5125:return V_;case 36294:return G_;case 36295:return k_;case 36296:return W_;case 35678:case 36198:case 36298:case 36306:case 35682:return X_;case 35679:case 36299:case 36307:return q_;case 35680:case 36300:case 36308:case 36293:return K_;case 36289:case 36303:case 36311:case 36292:return Y_}}class j_{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=C_(t.type)}}class Z_{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$_(t.type)}}class J_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const ko=/(\w+)(\])?(\[|\.)?/g;function Sc(n,e){n.seq.push(e),n.map[e.id]=e}function Q_(n,e,t){const i=n.name,r=i.length;for(ko.lastIndex=0;;){const s=ko.exec(i),o=ko.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Sc(t,c===void 0?new j_(a,n,e):new Z_(a,n,e));break}else{let f=t.map[a];f===void 0&&(f=new J_(a),Sc(t,f)),t=f}}}class bs{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Q_(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Mc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const ev=37297;let tv=0;function nv(n,e){const t=n.split(`
...
#define LOW_PRECISION`),e}function pv(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Cu?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Pd?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===yn&&(e="SHADOWMAP_TYPE_VSM"),e}function mv(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ji:case Zi:e="ENVMAP_TYPE_CUBE";break;case Xs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function gv(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Zi:e="ENVMAP_MODE_REFRACTION";break}return e}function _v(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Pu:e="ENVMAP_BLENDING_MULTIPLY";break;case nh:e="ENVMAP_BLENDING_MIX";break;case ih:e="ENVMAP_BLENDING_ADD";break}return e}function vv(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function xv(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=pv(t),c=mv(t),u=gv(t),f=_v(t),d=vv(t),p=ov(t),_=av(s),v=r.createProgram();let m,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Ia(n,e){const t=new Set(n.split(","));return i=>t.has(i)}const it={},Ki=[],Wt=()=>{},m0=()=>!1,Zs=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),Na=n=>n.startsWith("onUpdate:"),mt=Object.assign,Fa=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},g0=Object.prototype.hasOwnProperty,We=(n,e)=>g0.call(n,e),Be=Array.isArray,Tr=n=>Js(n)==="[object Map]",_0=n=>Js(n)==="[object Set]",Ge=n=>typeof n=="function",vt=n=>typeof n=="string",Wr=n=>typeof n=="symbol",at=n=>n!==null&&typeof n=="object",pf=n=>(at(n)||Ge(n))&&Ge(n.then)&&Ge(n.catch),v0=Object.prototype.toString,Js=n=>v0.call(n),x0=n=>Js(n).slice(8,-1),S0=n=>Js(n)==="[object Object]",Oa=n=>vt(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,br=Ia(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qs=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},M0=/-(\w)/g,pn=Qs(n=>n.replace(M0,(e,t)=>t?t.toUpperCase():"")),y0=/\B([A-Z])/g,ur=Qs(n=>n.replace(y0,"-$1").toLowerCase()),eo=Qs(n=>n.charAt(0).toUpperCase()+n.slice(1)),qo=Qs(n=>n?`on${eo(n)}`:""),Jn=(n,e)=>!Object.is(n,e),Ko=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},mf=(n,e,t,i=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:i,value:t})},E0=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let Dc;const gf=()=>Dc||(Dc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function za(n){if(Be(n)){const e={};for(let t=0;t<n.length;t++){const i=n[t],r=vt(i)?w0(i):za(i);if(r)for(const s in r)e[s]=r[s]}return e}else if(vt(n)||at(n))return n}const T0=/;(?![^(]*\))/g,b0=/:([^]+)/,A0=/\/\*[^]*?\*\//g;function w0(n){const e={};return n.replace(A0,"").split(T0).forEach(t=>{if(t){const i=t.split(b0);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function Ba(n){let e="";if(vt(n))e=n;else if(Be(n))for(let t=0;t<n.length;t++){const i=Ba(n[t]);i&&(e+=i+" ")}else if(at(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const R0="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",C0=Ia(R0);function _f(n){return!!n||n===""}/**
* @vue/reactivity v3.4.29
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Yt;class P0{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Yt,!e&&Yt&&(this.index=(Yt.scopes||(Yt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const t=Yt;try{return Yt=this,e()}finally{Yt=t}}}on(){Yt=this}off(){Yt=this.parent}stop(e){if(this._active){let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.scopes)for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0,this._active=!1}}}function L0(n,e=Yt){e&&e.active&&e.effects.push(n)}function D0(){return Yt}let yi;class Ha{constructor(e,t,i,r){this.fn=e,this.trigger=t,this.scheduler=i,this.active=!0,this.deps=[],this._dirtyLevel=5,this._trackId=0,this._runnings=0,this._shouldSchedule=!1,this._depsLength=0,L0(this,r)}get dirty(){if(this._dirtyLevel===2)return!1;if(this._dirtyLevel===3||this._dirtyLevel===4){this._dirtyLevel=1,ti();for(let e=0;e<this._depsLength;e++){const t=this.deps[e];if(t.computed){if(t.computed.effect._dirtyLevel===2)return!0;if(U0(t.computed),this._dirtyLevel>=5)break}}this._dirtyLevel===1&&(this._dirtyLevel=0),ni()}return this._dirtyLevel>=5}set dirty(e){this._dirtyLevel=e?5:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let e=Kn,t=yi;try{return Kn=!0,yi=this,this._runnings++,Uc(this),this.fn()}finally{Ic(this),this._runnings--,yi=t,Kn=e}}stop(){this.active&&(Uc(this),Ic(this),this.onStop&&this.onStop(),this.active=!1)}}function U0(n){return n.value}function Uc(n){n._trackId++,n._depsLength=0}function Ic(n){if(n.deps.length>n._depsLength){for(let e=n._depsLength;e<n.deps.length;e++)vf(n.deps[e],n);n.deps.length=n._depsLength}}function vf(n,e){const t=n.get(e);t!==void 0&&e._trackId!==t&&(n.delete(e),n.size===0&&n.cleanup())}let Kn=!0,fa=0;const xf=[];function ti(){xf.push(Kn),Kn=!1}function ni(){const n=xf.pop();Kn=n===void 0?!0:n}function Va(){fa++}function Ga(){for(fa--;!fa&&da.length;)da.shift()()}function Sf(n,e,t){if(e.get(n)!==n._trackId){e.set(n,n._trackId);const i=n.deps[n._depsLength];i!==e?(i&&vf(i,n),n.deps[n._depsLength++]=e):n._depsLength++}}const da=[];function Mf(n,e,t){Va();for(const i of n.keys()){if(!n.computed&&i.computed&&n.get(i)===i._trackId&&i._runnings>0){i._dirtyLevel=2;continue}let r;i._dirtyLevel<e&&(r??(r=n.get(i)===i._trackId))&&(i._shouldSchedule||(i._shouldSchedule=i._dirtyLevel===0),i.computed&&i._dirtyLevel===2&&(i._shouldSchedule=!0),i._dirtyLevel=e),i._shouldSchedule&&(r??(r=n.get(i)===i._trackId))&&(i.trigger(),(!i._runnings||i.allowRecurse)&&i._dirtyLevel!==3&&(i._shouldSchedule=!1,i.scheduler&&da.push(i.scheduler)))}Ga()}const yf=(n,e)=>{const t=new Map;return t.cleanup=n,t.computed=e,t},ha=new WeakMap,Ei=Symbol(""),pa=Symbol("");function Dt(n,e,t){if(Kn&&yi){let i=ha.get(n);i||ha.set(n,i=new Map);let r=i.get(t);r||i.set(t,r=yf(()=>i.delete(t))),Sf(yi,r)}}function Cn(n,e,t,i,r,s){const o=ha.get(n);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(t==="length"&&Be(n)){const l=Number(i);o.forEach((c,u)=>{(u==="length"||!Wr(u)&&u>=l)&&a.push(c)})}else switch(t!==void 0&&a.push(o.get(t)),e){case"add":Be(n)?Oa(t)&&a.push(o.get("length")):(a.push(o.get(Ei)),Tr(n)&&a.push(o.get(pa)));break;case"delete":Be(n)||(a.push(o.get(Ei)),Tr(n)&&a.push(o.get(pa)));break;case"set":Tr(n)&&a.push(o.get(Ei));break}Va();for(const l of a)l&&Mf(l,5);Ga()}const I0=Ia("__proto__,__v_isRef,__isVue"),Ef=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(Wr)),Nc=N0();function N0(){const n={};return["includes","indexOf","lastIndexOf"].forEach(e=>{n[e]=function(...t){const i=Ze(this);for(let s=0,o=this.length;s<o;s++)Dt(i,"get",s+"");const r=i[e](...t);return r===-1||r===!1?i[e](...t.map(Ze)):r}}),["push","pop","shift","unshift","splice"].forEach(e=>{n[e]=function(...t){ti(),Va();const i=Ze(this)[e].apply(this,t);return Ga(),ni(),i}}),n}function F0(n){Wr(n)||(n=String(n));const e=Ze(this);return Dt(e,"has",n),e.hasOwnProperty(n)}class Tf{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,i){const r=this._isReadonly,s=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return s;if(t==="__v_raw")return i===(r?s?$0:Rf:s?wf:Af).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const o=Be(e);if(!r){if(o&&We(Nc,t))return Reflect.get(Nc,t,i);if(t==="hasOwnProperty")return F0}const a=Reflect.get(e,t,i);return(Wr(t)?Ef.has(t):I0(t))||(r||Dt(e,"get",t),s)?a:Ut(a)?o&&Oa(t)?a:a.value:at(a)?r?Pf(a):no(a):a}}class bf extends Tf{constructor(e=!1){super(!1,e)}set(e,t,i,r){let s=e[t];if(!this._isShallow){const l=Ur(s);if(!Hs(i)&&!Ur(i)&&(s=Ze(s),i=Ze(i)),!Be(e)&&Ut(s)&&!Ut(i))return l?!1:(s.value=i,!0)}const o=Be(e)&&Oa(t)?Number(t)<e.length:We(e,t),a=Reflect.set(e,t,i,r);return e===Ze(r)&&(o?Jn(i,s)&&Cn(e,"set",t,i):Cn(e,"add",t,i)),a}deleteProperty(e,t){const i=We(e,t);e[t];const r=Reflect.deleteProperty(e,t);return r&&i&&Cn(e,"delete",t,void 0),r}has(e,t){const i=Reflect.has(e,t);return(!Wr(t)||!Ef.has(t))&&Dt(e,"has",t),i}ownKeys(e){return Dt(e,"iterate",Be(e)?"length":Ei),Reflect.ownKeys(e)}}class O0 extends Tf{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const z0=new bf,B0=new O0,H0=new bf(!0);const ka=n=>n,to=n=>Reflect.getPrototypeOf(n);function xs(n,e,t=!1,i=!1){n=n.__v_raw;const r=Ze(n),s=Ze(e);t||(Jn(e,s)&&Dt(r,"get",e),Dt(r,"get",s));const{has:o}=to(r),a=i?ka:t?qa:Ir;if(o.call(r,e))return a(n.get(e));if(o.call(r,s))return a(n.get(s));n!==r&&n.get(e)}function Ss(n,e=!1){const t=this.__v_raw,i=Ze(t),r=Ze(n);return e||(Jn(n,r)&&Dt(i,"has",n),Dt(i,"has",r)),n===r?t.has(n):t.has(n)||t.has(r)}function Ms(n,e=!1){return n=n.__v_raw,!e&&Dt(Ze(n),"iterate",Ei),Reflect.get(n,"size",n)}function Fc(n){n=Ze(n);const e=Ze(this);return to(e).has.call(e,n)||(e.add(n),Cn(e,"add",n,n)),this}function Oc(n,e){e=Ze(e);const t=Ze(this),{has:i,get:r}=to(t);let s=i.call(t,n);s||(n=Ze(n),s=i.call(t,n));const o=r.call(t,n);return t.set(n,e),s?Jn(e,o)&&Cn(t,"set",n,e):Cn(t,"add",n,e),this}function zc(n){const e=Ze(this),{has:t,get:i}=to(e);let r=t.call(e,n);r||(n=Ze(n),r=t.call(e,n)),i&&i.call(e,n);const s=e.delete(n);return r&&Cn(e,"delete",n,void 0),s}function Bc(){const n=Ze(this),e=n.size!==0,t=n.clear();return e&&Cn(n,"clear",void 0,void 0),t}function ys(n,e){return function(i,r){const s=this,o=s.__v_raw,a=Ze(o),l=e?ka:n?qa:Ir;return!n&&Dt(a,"iterate",Ei),o.forEach((c,u)=>i.call(r,l(c),l(u),s))}}function Es(n,e,t){return function(...i){const r=this.__v_raw,s=Ze(r),o=Tr(s),a=n==="entries"||n===Symbol.iterator&&o,l=n==="keys"&&o,c=r[n](...i),u=t?ka:e?qa:Ir;return!e&&Dt(s,"iterate",l?pa:Ei),{next(){const{value:f,done:d}=c.next();return d?{value:f,done:d}:{value:a?[u(f[0]),u(f[1])]:u(f),done:d}},[Symbol.iterator](){return this}}}}function Hn(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function V0(){const n={get(s){return xs(this,s)},get size(){return Ms(this)},has:Ss,add:Fc,set:Oc,delete:zc,clear:Bc,forEach:ys(!1,!1)},e={get(s){return xs(this,s,!1,!0)},get size(){return Ms(this)},has:Ss,add:Fc,set:Oc,delete:zc,clear:Bc,forEach:ys(!1,!0)},t={get(s){return xs(this,s,!0)},get size(){return Ms(this,!0)},has(s){return Ss.call(this,s,!0)},add:Hn("add"),set:Hn("set"),delete:Hn("delete"),clear:Hn("clear"),forEach:ys(!0,!1)},i={get(s){return xs(this,s,!0,!0)},get size(){return Ms(this,!0)},has(s){return Ss.call(this,s,!0)},add:Hn("add"),set:Hn("set"),delete:Hn("delete"),clear:Hn("clear"),forEach:ys(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{n[s]=Es(s,!1,!1),t[s]=Es(s,!0,!1),e[s]=Es(s,!1,!0),i[s]=Es(s,!0,!0)}),[n,t,e,i]}const[G0,k0,W0,X0]=V0();function Wa(n,e){const t=e?n?X0:W0:n?k0:G0;return(i,r,s)=>r==="__v_isReactive"?!n:r==="__v_isReadonly"?n:r==="__v_raw"?i:Reflect.get(We(t,r)&&r in i?t:i,r,s)}const q0={get:Wa(!1,!1)},K0={get:Wa(!1,!0)},Y0={get:Wa(!0,!1)};const Af=new WeakMap,wf=new WeakMap,Rf=new WeakMap,$0=new WeakMap;function j0(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Z0(n){return n.__v_skip||!Object.isExtensible(n)?0:j0(x0(n))}function no(n){return Ur(n)?n:Xa(n,!1,z0,q0,Af)}function Cf(n){return Xa(n,!1,H0,K0,wf)}function Pf(n){return Xa(n,!0,B0,Y0,Rf)}function Xa(n,e,t,i,r){if(!at(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const s=r.get(n);if(s)return s;const o=Z0(n);if(o===0)return n;const a=new Proxy(n,o===2?i:t);return r.set(n,a),a}function Ar(n){return Ur(n)?Ar(n.__v_raw):!!(n&&n.__v_isReactive)}function Ur(n){return!!(n&&n.__v_isReadonly)}function Hs(n){return!!(n&&n.__v_isShallow)}function Lf(n){return n?!!n.__v_raw:!1}function Ze(n){const e=n&&n.__v_raw;return e?Ze(e):n}function J0(n){return Object.isExtensible(n)&&mf(n,"__v_skip",!0),n}const Ir=n=>at(n)?no(n):n,qa=n=>at(n)?Pf(n):n;class Df{constructor(e,t,i,r){this.getter=e,this._setter=t,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new Ha(()=>e(this._value),()=>As(this,this.effect._dirtyLevel===3?3:4)),this.effect.computed=this,this.effect.active=this._cacheable=!r,this.__v_isReadonly=i}get value(){const e=Ze(this);return(!e._cacheable||e.effect.dirty)&&Jn(e._value,e._value=e.effect.run())&&As(e,5),Uf(e),e.effect._dirtyLevel>=2&&As(e,3),e._value}set value(e){this._setter(e)}get _dirty(){return this.effect.dirty}set _dirty(e){this.effect.dirty=e}}function Q0(n,e,t=!1){let i,r;const s=Ge(n);return s?(i=n,r=Wt):(i=n.get,r=n.set),new Df(i,r,s||!r,t)}function Uf(n){var e;Kn&&yi&&(n=Ze(n),Sf(yi,(e=n.dep)!=null?e:n.dep=yf(()=>n.dep=void 0,n instanceof Df?n:void 0)))}function As(n,e=5,t,i){n=Ze(n);const r=n.dep;r&&Mf(r,e)}function Ut(n){return!!(n&&n.__v_isRef===!0)}function ex(n){return If(n,!1)}function tx(n){return If(n,!0)}function If(n,e){return Ut(n)?n:new nx(n,e)}class nx{constructor(e,t){this.__v_isShallow=t,this.dep=void 0,this.__v_isRef=!0,this._rawValue=t?e:Ze(e),this._value=t?e:Ir(e)}get value(){return Uf(this),this._value}set value(e){const t=this.__v_isShallow||Hs(e)||Ur(e);e=t?e:Ze(e),Jn(e,this._rawValue)&&(this._rawValue,this._rawValue=e,this._value=t?e:Ir(e),As(this,5))}}function Yi(n){return Ut(n)?n.value:n}const ix={get:(n,e,t)=>Yi(Reflect.get(n,e,t)),set:(n,e,t,i)=>{const r=n[e];return Ut(r)&&!Ut(t)?(r.value=t,!0):Reflect.set(n,e,t,i)}};function Nf(n){return Ar(n)?n:new Proxy(n,ix)}/**
* @vue/runtime-core v3.4.29
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Yn(n,e,t,i){try{return i?n(...i):n()}catch(r){io(r,e,t)}}function en(n,e,t,i){if(Ge(n)){const r=Yn(n,e,t,i);return r&&pf(r)&&r.catch(s=>{io(s,e,t)}),r}if(Be(n)){const r=[];for(let s=0;s<n.length;s++)r.push(en(n[s],e,t,i));return r}}function io(n,e,t,i=!0){const r=e?e.vnode:null;if(e){let s=e.parent;const o=e.proxy,a=`https://vuejs.org/error-reference/#runtime-${t}`;for(;s;){const c=s.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](n,o,a)===!1)return}s=s.parent}const l=e.appContext.config.errorHandler;if(l){ti(),Yn(l,null,10,[n,o,a]),ni();return}}rx(n,t,r,i)}function rx(n,e,t,i=!0){console.error(n)}let Nr=!1,ma=!1;const Mt=[];let fn=0;const $i=[];let Gn=null,vi=0;const Ff=Promise.resolve();let Ka=null;function Of(n){const e=Ka||Ff;return n?e.then(this?n.bind(this):n):e}function sx(n){let e=fn+1,t=Mt.length;for(;e<t;){const i=e+t>>>1,r=Mt[i],s=Fr(r);s<n||s===n&&r.pre?e=i+1:t=i}return e}function Ya(n){(!Mt.length||!Mt.includes(n,Nr&&n.allowRecurse?fn+1:fn))&&(n.id==null?Mt.push(n):Mt.splice(sx(n.id),0,n),zf())}function zf(){!Nr&&!ma&&(ma=!0,Ka=Ff.then(Hf))}function ox(n){const e=Mt.indexOf(n);e>fn&&Mt.splice(e,1)}function ax(n){Be(n)?$i.push(...n):(!Gn||!Gn.includes(n,n.allowRecurse?vi+1:vi))&&$i.push(n),zf()}function Hc(n,e,t=Nr?fn+1:0){for(;t<Mt.length;t++){const i=Mt[t];if(i&&i.pre){if(n&&i.id!==n.uid)continue;Mt.splice(t,1),t--,i()}}}function Bf(n){if($i.length){const e=[...new Set($i)].sort((t,i)=>Fr(t)-Fr(i));if($i.length=0,Gn){Gn.push(...e);return}for(Gn=e,vi=0;vi<Gn.length;vi++){const t=Gn[vi];t.active!==!1&&t()}Gn=null,vi=0}}const Fr=n=>n.id==null?1/0:n.id,lx=(n,e)=>{const t=Fr(n)-Fr(e);if(t===0){if(n.pre&&!e.pre)return-1;if(e.pre&&!n.pre)return 1}return t};function Hf(n){ma=!1,Nr=!0,Mt.sort(lx);try{for(fn=0;fn<Mt.length;fn++){const e=Mt[fn];e&&e.active!==!1&&Yn(e,null,14)}}finally{fn=0,Mt.length=0,Bf(),Nr=!1,Ka=null,(Mt.length||$i.length)&&Hf()}}function cx(n,e,...t){if(n.isUnmounted)return;const i=n.vnode.props||it;let r=t;const s=e.startsWith("update:"),o=s&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:f,trim:d}=i[u]||it;d&&(r=t.map(p=>vt(p)?p.trim():p)),f&&(r=t.map(E0))}let a,l=i[a=qo(e)]||i[a=qo(pn(e))];!l&&s&&(l=i[a=qo(ur(e))]),l&&en(l,n,6,r);const c=i[a+"Once"];if(c){if(!n.emitted)n.emitted={};else if(n.emitted[a])return;n.emitted[a]=!0,en(c,n,6,r)}}function Vf(n,e,t=!1){const i=e.emitsCache,r=i.get(n);if(r!==void 0)return r;const s=n.emits;let o={},a=!1;if(!Ge(n)){const l=c=>{const u=Vf(c,e,!0);u&&(a=!0,mt(o,u))};!t&&e.mixins.length&&e.mixins.forEach(l),n.extends&&l(n.extends),n.mixins&&n.mixins.forEach(l)}return!s&&!a?(at(n)&&i.set(n,null),null):(Be(s)?s.forEach(l=>o[l]=null):mt(o,s),at(n)&&i.set(n,o),o)}function ro(n,e){return!n||!Zs(e)?!1:(e=e.slice(2).replace(/Once$/,""),We(n,e[0].toLowerCase()+e.slice(1))||We(n,ur(e))||We(n,e))}let Jt=null,so=null;function Vs(n){const e=Jt;return Jt=n,so=n&&n.type.__scopeId||null,e}function ux(n){so=n}function fx(){so=null}function vr(n,e=Jt,t){if(!e||n._n)return n;const i=(...r)=>{i._d&&Qc(-1);const s=Vs(e);let o;try{o=n(...r)}finally{Vs(s),i._d&&Qc(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function Yo(n){const{type:e,vnode:t,proxy:i,withProxy:r,propsOptions:[s],slots:o,attrs:a,emit:l,render:c,renderCache:u,props:f,data:d,setupState:p,ctx:_,inheritAttrs:v}=n,m=Vs(n);let h,T;try{if(t.shapeFlag&4){const A=r||i,V=A;h=cn(c.call(V,A,u,f,p,d,_)),T=a}else{const A=e;h=cn(A.length>1?A(f,{attrs:a,slots:o,emit:l}):A(f,null)),T=e.props?a:dx(a)}}catch(A){Cr.length=0,io(A,n,1),h=gt(Or)}let y=h;if(T&&v!==!1){const A=Object.keys(T),{shapeFlag:V}=y;A.length&&V&7&&(s&&A.some(Na)&&(T=hx(T,s)),y=nr(y,T,!1,!0))}return t.dirs&&(y=nr(y,null,!1,!0),y.dirs=y.dirs?y.dirs.concat(t.dirs):t.dirs),t.transition&&(y.transition=t.transition),h=y,Vs(m),h}const dx=n=>{let e;for(const t in n)(t==="class"||t==="style"||Zs(t))&&((e||(e={}))[t]=n[t]);return e},hx=(n,e)=>{const t={};for(const i in n)(!Na(i)||!(i.slice(9)in e))&&(t[i]=n[i]);return t};function px(n,e,t){const{props:i,children:r,component:s}=n,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&l>=0){if(l&1024)return!0;if(l&16)return i?Vc(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const d=u[f];if(o[d]!==i[d]&&!ro(c,d))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?Vc(i,o,c):!0:!!o;return!1}function Vc(n,e,t){const i=Object.keys(e);if(i.length!==Object.keys(n).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(e[s]!==n[s]&&!ro(t,s))return!0}return!1}function mx({vnode:n,parent:e},t){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.el=n.el),i===n)(n=e.vnode).el=t,e=e.parent;else break}}const Gf="components";function Gc(n,e){return _x(Gf,n,!0,e)||n}const gx=Symbol.for("v-ndc");function _x(n,e,t=!0,i=!1){const r=Jt||yt;if(r){const s=r.type;if(n===Gf){const a=fS(s,!1);if(a&&(a===e||a===pn(e)||a===eo(pn(e))))return s}const o=kc(r[n]||s[n],e)||kc(r.appContext[n],e);return!o&&i?s:o}}function kc(n,e){return n&&(n[e]||n[pn(e)]||n[eo(pn(e))])}const vx=n=>n.__isSuspense;function xx(n,e){e&&e.pendingBranch?Be(n)?e.effects.push(...n):e.effects.push(n):ax(n)}function oo(n,e,t=yt,i=!1){if(t){const r=t[n]||(t[n]=[]),s=e.__weh||(e.__weh=(...o)=>{ti();const a=Xr(t),l=en(e,t,n,o);return a(),ni(),l});return i?r.unshift(s):r.push(s),s}}const Dn=n=>(e,t=yt)=>{(!lo||n==="sp")&&oo(n,(...i)=>e(...i),t)},Sx=Dn("bm"),Mx=Dn("m"),yx=Dn("bu"),Ex=Dn("u"),Tx=Dn("bum"),kf=Dn("um"),bx=Dn("sp"),Ax=Dn("rtg"),wx=Dn("rtc");function Rx(n,e=yt){oo("ec",n,e)}function fi(n,e,t,i){const r=n.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(ti(),en(l,t,8,[n.el,a,n,e]),ni())}}/*! #__NO_SIDE_EFFECTS__ */function Wf(n,e){return Ge(n)?mt({name:n.name},e,{setup:n}):n}const ws=n=>!!n.type.__asyncLoader,ga=n=>n?ud(n)?el(n):ga(n.parent):null,wr=mt(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>ga(n.parent),$root:n=>ga(n.root),$emit:n=>n.emit,$options:n=>$a(n),$forceUpdate:n=>n.f||(n.f=()=>{n.effect.dirty=!0,Ya(n.update)}),$nextTick:n=>n.n||(n.n=Of.bind(n.proxy)),$watch:n=>Yx.bind(n)}),$o=(n,e)=>n!==it&&!n.__isScriptSetup&&We(n,e),Cx={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=n;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return r[e];case 4:return t[e];case 3:return s[e]}else{if($o(i,e))return o[e]=1,i[e];if(r!==it&&We(r,e))return o[e]=2,r[e];if((c=n.propsOptions[0])&&We(c,e))return o[e]=3,s[e];if(t!==it&&We(t,e))return o[e]=4,t[e];_a&&(o[e]=0)}}const u=wr[e];let f,d;if(u)return e==="$attrs"&&Dt(n.attrs,"get",""),u(n);if((f=a.__cssModules)&&(f=f[e]))return f;if(t!==it&&We(t,e))return o[e]=4,t[e];if(d=l.config.globalProperties,We(d,e))return d[e]},set({_:n},e,t){const{data:i,setupState:r,ctx:s}=n;return $o(r,e)?(r[e]=t,!0):i!==it&&We(i,e)?(i[e]=t,!0):We(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(s[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:i,appContext:r,propsOptions:s}},o){let a;return!!t[o]||n!==it&&We(n,o)||$o(e,o)||(a=s[0])&&We(a,o)||We(i,o)||We(wr,o)||We(r.config.globalProperties,o)},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:We(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Wc(n){return Be(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let _a=!0;function Px(n){const e=$a(n),t=n.proxy,i=n.ctx;_a=!1,e.beforeCreate&&Xc(e.beforeCreate,n,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:f,mounted:d,beforeUpdate:p,updated:_,activated:v,deactivated:m,beforeDestroy:h,beforeUnmount:T,destroyed:y,unmounted:A,render:V,renderTracked:C,renderTriggered:L,errorCaptured:H,serverPrefetch:b,expose:M,inheritAttrs:U,components:Q,directives:Y,filters:se}=e;if(c&&Lx(c,i,null),o)for(const Z in o){const G=o[Z];Ge(G)&&(i[Z]=G.bind(t))}if(r){const Z=r.call(t,t);at(Z)&&(n.data=no(Z))}if(_a=!0,s)for(const Z in s){const G=s[Z],xe=Ge(G)?G.bind(t,t):Ge(G.get)?G.get.bind(t,t):Wt,Me=!Ge(G)&&Ge(G.set)?G.set.bind(t):Wt,ye=jt({get:xe,set:Me});Object.defineProperty(i,Z,{enumerable:!0,configurable:!0,get:()=>ye.value,set:Le=>ye.value=Le})}if(a)for(const Z in a)Xf(a[Z],i,t,Z);if(l){const Z=Ge(l)?l.call(t):l;Reflect.ownKeys(Z).forEach(G=>{Rs(G,Z[G])})}u&&Xc(u,n,"c");function j(Z,G){Be(G)?G.forEach(xe=>Z(xe.bind(t))):G&&Z(G.bind(t))}if(j(Sx,f),j(Mx,d),j(yx,p),j(Ex,_),j($x,v),j(jx,m),j(Rx,H),j(wx,C),j(Ax,L),j(Tx,T),j(kf,A),j(bx,b),Be(M))if(M.length){const Z=n.exposed||(n.exposed={});M.forEach(G=>{Object.defineProperty(Z,G,{get:()=>t[G],set:xe=>t[G]=xe})})}else n.exposed||(n.exposed={});V&&n.render===Wt&&(n.render=V),U!=null&&(n.inheritAttrs=U),Q&&(n.components=Q),Y&&(n.directives=Y)}function Lx(n,e,t=Wt){Be(n)&&(n=va(n));for(const i in n){const r=n[i];let s;at(r)?"default"in r?s=Pn(r.from||i,r.default,!0):s=Pn(r.from||i):s=Pn(r),Ut(s)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[i]=s}}function Xc(n,e,t){en(Be(n)?n.map(i=>i.bind(e.proxy)):n.bind(e.proxy),e,t)}function Xf(n,e,t,i){const r=i.includes(".")?rd(t,i):()=>t[i];if(vt(n)){const s=e[n];Ge(s)&&Cs(r,s)}else if(Ge(n))Cs(r,n.bind(t));else if(at(n))if(Be(n))n.forEach(s=>Xf(s,e,t,i));else{const s=Ge(n.handler)?n.handler.bind(t):e[n.handler];Ge(s)&&Cs(r,s,n)}}function $a(n){const e=n.type,{mixins:t,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=n.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!t&&!i?l=e:(l={},r.length&&r.forEach(c=>Gs(l,c,o,!0)),Gs(l,e,o)),at(e)&&s.set(e,l),l}function Gs(n,e,t,i=!1){const{mixins:r,extends:s}=e;s&&Gs(n,s,t,!0),r&&r.forEach(o=>Gs(n,o,t,!0));for(const o in e)if(!(i&&o==="expose")){const a=Dx[o]||t&&t[o];n[o]=a?a(n[o],e[o]):e[o]}return n}const Dx={data:qc,props:Kc,emits:Kc,methods:xr,computed:xr,beforeCreate:bt,created:bt,beforeMount:bt,mounted:bt,beforeUpdate:bt,updated:bt,beforeDestroy:bt,beforeUnmount:bt,destroyed:bt,unmounted:bt,activated:bt,deactivated:bt,errorCaptured:bt,serverPrefetch:bt,components:xr,directives:xr,watch:Ix,provide:qc,inject:Ux};function qc(n,e){return e?n?function(){return mt(Ge(n)?n.call(this,this):n,Ge(e)?e.call(this,this):e)}:e:n}function Ux(n,e){return xr(va(n),va(e))}function va(n){if(Be(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function bt(n,e){return n?[...new Set([].concat(n,e))]:e}function xr(n,e){return n?mt(Object.create(null),n,e):e}function Kc(n,e){return n?Be(n)&&Be(e)?[...new Set([...n,...e])]:mt(Object.create(null),Wc(n),Wc(e??{})):e}function Ix(n,e){if(!n)return e;if(!e)return n;const t=mt(Object.create(null),n);for(const i in e)t[i]=bt(n[i],e[i]);return t}function qf(){return{app:null,config:{isNativeTag:m0,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Nx=0;function Fx(n,e){return function(i,r=null){Ge(i)||(i=mt({},i)),r!=null&&!at(r)&&(r=null);const s=qf(),o=new WeakSet;let a=!1;const l=s.app={_uid:Nx++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:hS,get config(){return s.config},set config(c){},use(c,...u){return o.has(c)||(c&&Ge(c.install)?(o.add(c),c.install(l,...u)):Ge(c)&&(o.add(c),c(l,...u))),l},mixin(c){return s.mixins.includes(c)||s.mixins.push(c),l},component(c,u){return u?(s.components[c]=u,l):s.components[c]},directive(c,u){return u?(s.directives[c]=u,l):s.directives[c]},mount(c,u,f){if(!a){const d=gt(i,r);return d.appContext=s,f===!0?f="svg":f===!1&&(f=void 0),u&&e?e(d,c):n(d,c,f),a=!0,l._container=c,c.__vue_app__=l,el(d.component)}},unmount(){a&&(n(null,l._container),delete l._container.__vue_app__)},provide(c,u){return s.provides[c]=u,l},runWithContext(c){const u=Rr;Rr=l;try{return c()}finally{Rr=u}}};return l}}let Rr=null;function Rs(n,e){if(yt){let t=yt.provides;const i=yt.parent&&yt.parent.provides;i===t&&(t=yt.provides=Object.create(i)),t[n]=e}}function Pn(n,e,t=!1){const i=yt||Jt;if(i||Rr){const r=i?i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:Rr._context.provides;if(r&&n in r)return r[n];if(arguments.length>1)return t&&Ge(e)?e.call(i&&i.proxy):e}}const Kf={},Yf=()=>Object.create(Kf),$f=n=>Object.getPrototypeOf(n)===Kf;function Ox(n,e,t,i=!1){const r={},s=Yf();n.propsDefaults=Object.create(null),jf(n,e,r,s);for(const o in n.propsOptions[0])o in r||(r[o]=void 0);t?n.props=i?r:Cf(r):n.type.props?n.props=r:n.props=s,n.attrs=s}function zx(n,e,t,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=n,a=Ze(r),[l]=n.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=n.vnode.dynamicProps;for(let f=0;f<u.length;f++){let d=u[f];if(ro(n.emitsOptions,d))continue;const p=e[d];if(l)if(We(s,d))p!==s[d]&&(s[d]=p,c=!0);else{const _=pn(d);r[_]=xa(l,a,_,p,n,!1)}else p!==s[d]&&(s[d]=p,c=!0)}}}else{jf(n,e,r,s)&&(c=!0);let u;for(const f in a)(!e||!We(e,f)&&((u=ur(f))===f||!We(e,u)))&&(l?t&&(t[f]!==void 0||t[u]!==void 0)&&(r[f]=xa(l,a,f,void 0,n,!0)):delete r[f]);if(s!==a)for(const f in s)(!e||!We(e,f))&&(delete s[f],c=!0)}c&&Cn(n.attrs,"set","")}function jf(n,e,t,i){const[r,s]=n.propsOptions;let o=!1,a;if(e)for(let l in e){if(br(l))continue;const c=e[l];let u;r&&We(r,u=pn(l))?!s||!s.includes(u)?t[u]=c:(a||(a={}))[u]=c:ro(n.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(s){const l=Ze(t),c=a||it;for(let u=0;u<s.length;u++){const f=s[u];t[f]=xa(r,l,f,c[f],n,!We(c,f))}}return o}function xa(n,e,t,i,r,s){const o=n[t];if(o!=null){const a=We(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&Ge(l)){const{propsDefaults:c}=r;if(t in c)i=c[t];else{const u=Xr(r);i=c[t]=l.call(null,e),u()}}else i=l}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===ur(t))&&(i=!0))}return i}function Zf(n,e,t=!1){const i=e.propsCache,r=i.get(n);if(r)return r;const s=n.props,o={},a=[];let l=!1;if(!Ge(n)){const u=f=>{l=!0;const[d,p]=Zf(f,e,!0);mt(o,d),p&&a.push(...p)};!t&&e.mixins.length&&e.mixins.forEach(u),n.extends&&u(n.extends),n.mixins&&n.mixins.forEach(u)}if(!s&&!l)return at(n)&&i.set(n,Ki),Ki;if(Be(s))for(let u=0;u<s.length;u++){const f=pn(s[u]);Yc(f)&&(o[f]=it)}else if(s)for(const u in s){const f=pn(u);if(Yc(f)){const d=s[u],p=o[f]=Be(d)||Ge(d)?{type:d}:mt({},d);if(p){const _=Zc(Boolean,p.type),v=Zc(String,p.type);p[0]=_>-1,p[1]=v<0||_<v,(_>-1||We(p,"default"))&&a.push(f)}}}const c=[o,a];return at(n)&&i.set(n,c),c}function Yc(n){return n[0]!=="$"&&!br(n)}function $c(n){return n===null?"null":typeof n=="function"?n.name||"":typeof n=="object"&&n.constructor&&n.constructor.name||""}function jc(n,e){return $c(n)===$c(e)}function Zc(n,e){return Be(e)?e.findIndex(t=>jc(t,n)):Ge(e)&&jc(e,n)?0:-1}const Jf=n=>n[0]==="_"||n==="$stable",ja=n=>Be(n)?n.map(cn):[cn(n)],Bx=(n,e,t)=>{if(e._n)return e;const i=vr((...r)=>ja(e(...r)),t);return i._c=!1,i},Qf=(n,e,t)=>{const i=n._ctx;for(const r in n){if(Jf(r))continue;const s=n[r];if(Ge(s))e[r]=Bx(r,s,i);else if(s!=null){const o=ja(s);e[r]=()=>o}}},ed=(n,e)=>{const t=ja(e);n.slots.default=()=>t},Hx=(n,e)=>{const t=n.slots=Yf();if(n.vnode.shapeFlag&32){const i=e._;i?(mt(t,e),mf(t,"_",i,!0)):Qf(e,t)}else e&&ed(n,e)},Vx=(n,e,t)=>{const{vnode:i,slots:r}=n;let s=!0,o=it;if(i.shapeFlag&32){const a=e._;a?t&&a===1?s=!1:(mt(r,e),!t&&a===1&&delete r._):(s=!e.$stable,Qf(e,r)),o=e}else e&&(ed(n,e),o={default:1});if(s)for(const a in r)!Jf(a)&&o[a]==null&&delete r[a]};function Sa(n,e,t,i,r=!1){if(Be(n)){n.forEach((d,p)=>Sa(d,e&&(Be(e)?e[p]:e),t,i,r));return}if(ws(i)&&!r)return;const s=i.shapeFlag&4?el(i.component):i.el,o=r?null:s,{i:a,r:l}=n,c=e&&e.r,u=a.refs===it?a.refs={}:a.refs,f=a.setupState;if(c!=null&&c!==l&&(vt(c)?(u[c]=null,We(f,c)&&(f[c]=null)):Ut(c)&&(c.value=null)),Ge(l))Yn(l,a,12,[o,u]);else{const d=vt(l),p=Ut(l);if(d||p){const _=()=>{if(n.f){const v=d?We(f,l)?f[l]:u[l]:l.value;r?Be(v)&&Fa(v,s):Be(v)?v.includes(s)||v.push(s):d?(u[l]=[s],We(f,l)&&(f[l]=u[l])):(l.value=[s],n.k&&(u[n.k]=l.value))}else d?(u[l]=o,We(f,l)&&(f[l]=o)):p&&(l.value=o,n.k&&(u[n.k]=o))};o?(_.id=-1,Ct(_,t)):_()}}}const Ct=xx;function Gx(n){return kx(n)}function kx(n,e){const t=gf();t.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:f,nextSibling:d,setScopeId:p=Wt,insertStaticContent:_}=n,v=(E,w,I,K=null,B=null,J=null,fe=void 0,x=null,g=!!w.dynamicChildren)=>{if(E===w)return;E&&!mr(E,w)&&(K=N(E),Le(E,B,J,!0),E=null),w.patchFlag===-2&&(g=!1,w.dynamicChildren=null);const{type:R,ref:O,shapeFlag:X}=w;switch(R){case ao:m(E,w,I,K);break;case Or:h(E,w,I,K);break;case Ps:E==null&&T(w,I,K,fe);break;case ln:Q(E,w,I,K,B,J,fe,x,g);break;default:X&1?V(E,w,I,K,B,J,fe,x,g):X&6?Y(E,w,I,K,B,J,fe,x,g):(X&64||X&128)&&R.process(E,w,I,K,B,J,fe,x,g,de)}O!=null&&B&&Sa(O,E&&E.ref,J,w||E,!w)},m=(E,w,I,K)=>{if(E==null)i(w.el=a(w.children),I,K);else{const B=w.el=E.el;w.children!==E.children&&c(B,w.children)}},h=(E,w,I,K)=>{E==null?i(w.el=l(w.children||""),I,K):w.el=E.el},T=(E,w,I,K)=>{[E.el,E.anchor]=_(E.children,w,I,K,E.el,E.anchor)},y=({el:E,anchor:w},I,K)=>{let B;for(;E&&E!==w;)B=d(E),i(E,I,K),E=B;i(w,I,K)},A=({el:E,anchor:w})=>{let I;for(;E&&E!==w;)I=d(E),r(E),E=I;r(w)},V=(E,w,I,K,B,J,fe,x,g)=>{w.type==="svg"?fe="svg":w.type==="math"&&(fe="mathml"),E==null?C(w,I,K,B,J,fe,x,g):b(E,w,B,J,fe,x,g)},C=(E,w,I,K,B,J,fe,x)=>{let g,R;const{props:O,shapeFlag:X,transition:k,dirs:ue}=E;if(g=E.el=o(E.type,J,O&&O.is,O),X&8?u(g,E.children):X&16&&H(E.children,g,null,K,B,jo(E,J),fe,x),ue&&fi(E,null,K,"created"),L(g,E,E.scopeId,fe,K),O){for(const ce in O)ce!=="value"&&!br(ce)&&s(g,ce,null,O[ce],J,E.children,K,B,ge);"value"in O&&s(g,"value",null,O.value,J),(R=O.onVnodeBeforeMount)&&sn(R,K,E)}ue&&fi(E,null,K,"beforeMount");const re=Wx(B,k);re&&k.beforeEnter(g),i(g,w,I),((R=O&&O.onVnodeMounted)||re||ue)&&Ct(()=>{R&&sn(R,K,E),re&&k.enter(g),ue&&fi(E,null,K,"mounted")},B)},L=(E,w,I,K,B)=>{if(I&&p(E,I),K)for(let J=0;J<K.length;J++)p(E,K[J]);if(B){let J=B.subTree;if(w===J){const fe=B.vnode;L(E,fe,fe.scopeId,fe.slotScopeIds,B.parent)}}},H=(E,w,I,K,B,J,fe,x,g=0)=>{for(let R=g;R<E.length;R++){const O=E[R]=x?kn(E[R]):cn(E[R]);v(null,O,w,I,K,B,J,fe,x)}},b=(E,w,I,K,B,J,fe)=>{const x=w.el=E.el;let{patchFlag:g,dynamicChildren:R,dirs:O}=w;g|=E.patchFlag&16;const X=E.props||it,k=w.props||it;let ue;if(I&&di(I,!1),(ue=k.onVnodeBeforeUpdate)&&sn(ue,I,w,E),O&&fi(w,E,I,"beforeUpdate"),I&&di(I,!0),R?M(E.dynamicChildren,R,x,I,K,jo(w,B),J):fe||G(E,w,x,null,I,K,jo(w,B),J,!1),g>0){if(g&16)U(x,w,X,k,I,K,B);else if(g&2&&X.class!==k.class&&s(x,"class",null,k.class,B),g&4&&s(x,"style",X.style,k.style,B),g&8){const re=w.dynamicProps;for(let ce=0;ce<re.length;ce++){const Se=re[ce],le=X[Se],Ee=k[Se];(Ee!==le||Se==="value")&&s(x,Se,le,Ee,B,E.children,I,K,ge)}}g&1&&E.children!==w.children&&u(x,w.children)}else!fe&&R==null&&U(x,w,X,k,I,K,B);((ue=k.onVnodeUpdated)||O)&&Ct(()=>{ue&&sn(ue,I,w,E),O&&fi(w,E,I,"updated")},K)},M=(E,w,I,K,B,J,fe)=>{for(let x=0;x<w.length;x++){const g=E[x],R=w[x],O=g.el&&(g.type===ln||!mr(g,R)||g.shapeFlag&70)?f(g.el):I;v(g,R,O,null,K,B,J,fe,!0)}},U=(E,w,I,K,B,J,fe)=>{if(I!==K){if(I!==it)for(const x in I)!br(x)&&!(x in K)&&s(E,x,I[x],null,fe,w.children,B,J,ge);for(const x in K){if(br(x))continue;const g=K[x],R=I[x];g!==R&&x!=="value"&&s(E,x,R,g,fe,w.children,B,J,ge)}"value"in K&&s(E,"value",I.value,K.value,fe)}},Q=(E,w,I,K,B,J,fe,x,g)=>{const R=w.el=E?E.el:a(""),O=w.anchor=E?E.anchor:a("");let{patchFlag:X,dynamicChildren:k,slotScopeIds:ue}=w;ue&&(x=x?x.concat(ue):ue),E==null?(i(R,I,K),i(O,I,K),H(w.children||[],I,O,B,J,fe,x,g)):X>0&&X&64&&k&&E.dynamicChildren?(M(E.dynamicChildren,k,I,B,J,fe,x),(w.key!=null||B&&w===B.subTree)&&td(E,w,!0)):G(E,w,I,O,B,J,fe,x,g)},Y=(E,w,I,K,B,J,fe,x,g)=>{w.slotScopeIds=x,E==null?w.shapeFlag&512?B.ctx.activate(w,I,K,fe,g):se(w,I,K,B,J,fe,g):ie(E,w,g)},se=(E,w,I,K,B,J,fe)=>{const x=E.component=oS(E,K,B);if(sd(E)&&(x.ctx.renderer=de),aS(x),x.asyncDep){if(B&&B.registerDep(x,j,fe),!E.el){const g=x.subTree=gt(Or);h(null,g,w,I)}}else j(x,E,w,I,B,J,fe)},ie=(E,w,I)=>{const K=w.component=E.component;if(px(E,w,I))if(K.asyncDep&&!K.asyncResolved){Z(K,w,I);return}else K.next=w,ox(K.update),K.effect.dirty=!0,K.update();else w.el=E.el,K.vnode=w},j=(E,w,I,K,B,J,fe)=>{const x=()=>{if(E.isMounted){let{next:O,bu:X,u:k,parent:ue,vnode:re}=E;{const Oe=nd(E);if(Oe){O&&(O.el=re.el,Z(E,O,fe)),Oe.asyncDep.then(()=>{E.isUnmounted||x()});return}}let ce=O,Se;di(E,!1),O?(O.el=re.el,Z(E,O,fe)):O=re,X&&Ko(X),(Se=O.props&&O.props.onVnodeBeforeUpdate)&&sn(Se,ue,O,re),di(E,!0);const le=Yo(E),Ee=E.subTree;E.subTree=le,v(Ee,le,f(Ee.el),N(Ee),E,B,J),O.el=le.el,ce===null&&mx(E,le.el),k&&Ct(k,B),(Se=O.props&&O.props.onVnodeUpdated)&&Ct(()=>sn(Se,ue,O,re),B)}else{let O;const{el:X,props:k}=w,{bm:ue,m:re,parent:ce}=E,Se=ws(w);if(di(E,!1),ue&&Ko(ue),!Se&&(O=k&&k.onVnodeBeforeMount)&&sn(O,ce,w),di(E,!0),X&&we){const le=()=>{E.subTree=Yo(E),we(X,E.subTree,E,B,null)};Se?w.type.__asyncLoader().then(()=>!E.isUnmounted&&le()):le()}else{const le=E.subTree=Yo(E);v(null,le,I,K,E,B,J),w.el=le.el}if(re&&Ct(re,B),!Se&&(O=k&&k.onVnodeMounted)){const le=w;Ct(()=>sn(O,ce,le),B)}(w.shapeFlag&256||ce&&ws(ce.vnode)&&ce.vnode.shapeFlag&256)&&E.a&&Ct(E.a,B),E.isMounted=!0,w=I=K=null}},g=E.effect=new Ha(x,Wt,()=>Ya(R),E.scope),R=E.update=()=>{g.dirty&&g.run()};R.id=E.uid,di(E,!0),R()},Z=(E,w,I)=>{w.component=E;const K=E.vnode.props;E.vnode=w,E.next=null,zx(E,w.props,K,I),Vx(E,w.children,I),ti(),Hc(E),ni()},G=(E,w,I,K,B,J,fe,x,g=!1)=>{const R=E&&E.children,O=E?E.shapeFlag:0,X=w.children,{patchFlag:k,shapeFlag:ue}=w;if(k>0){if(k&128){Me(R,X,I,K,B,J,fe,x,g);return}else if(k&256){xe(R,X,I,K,B,J,fe,x,g);return}}ue&8?(O&16&&ge(R,B,J),X!==R&&u(I,X)):O&16?ue&16?Me(R,X,I,K,B,J,fe,x,g):ge(R,B,J,!0):(O&8&&u(I,""),ue&16&&H(X,I,K,B,J,fe,x,g))},xe=(E,w,I,K,B,J,fe,x,g)=>{E=E||Ki,w=w||Ki;const R=E.length,O=w.length,X=Math.min(R,O);let k;for(k=0;k<X;k++){const ue=w[k]=g?kn(w[k]):cn(w[k]);v(E[k],ue,I,null,B,J,fe,x,g)}R>O?ge(E,B,J,!0,!1,X):H(w,I,K,B,J,fe,x,g,X)},Me=(E,w,I,K,B,J,fe,x,g)=>{let R=0;const O=w.length;let X=E.length-1,k=O-1;for(;R<=X&&R<=k;){const ue=E[R],re=w[R]=g?kn(w[R]):cn(w[R]);if(mr(ue,re))v(ue,re,I,null,B,J,fe,x,g);else break;R++}for(;R<=X&&R<=k;){const ue=E[X],re=w[k]=g?kn(w[k]):cn(w[k]);if(mr(ue,re))v(ue,re,I,null,B,J,fe,x,g);else break;X--,k--}if(R>X){if(R<=k){const ue=k+1,re=ue<O?w[ue].el:K;for(;R<=k;)v(null,w[R]=g?kn(w[R]):cn(w[R]),I,re,B,J,fe,x,g),R++}}else if(R>k)for(;R<=X;)Le(E[R],B,J,!0),R++;else{const ue=R,re=R,ce=new Map;for(R=re;R<=k;R++){const De=w[R]=g?kn(w[R]):cn(w[R]);De.key!=null&&ce.set(De.key,R)}let Se,le=0;const Ee=k-re+1;let Oe=!1,Ue=0;const _e=new Array(Ee);for(R=0;R<Ee;R++)_e[R]=0;for(R=ue;R<=X;R++){const De=E[R];if(le>=Ee){Le(De,B,J,!0);continue}let Xe;if(De.key!=null)Xe=ce.get(De.key);else for(Se=re;Se<=k;Se++)if(_e[Se-re]===0&&mr(De,w[Se])){Xe=Se;break}Xe===void 0?Le(De,B,J,!0):(_e[Xe-re]=R+1,Xe>=Ue?Ue=Xe:Oe=!0,v(De,w[Xe],I,null,B,J,fe,x,g),le++)}const ze=Oe?Xx(_e):Ki;for(Se=ze.length-1,R=Ee-1;R>=0;R--){const De=re+R,Xe=w[De],D=De+1<O?w[De+1].el:K;_e[R]===0?v(null,Xe,I,D,B,J,fe,x,g):Oe&&(Se<0||R!==ze[Se]?ye(Xe,I,D,2):Se--)}}},ye=(E,w,I,K,B=null)=>{const{el:J,type:fe,transition:x,children:g,shapeFlag:R}=E;if(R&6){ye(E.component.subTree,w,I,K);return}if(R&128){E.suspense.move(w,I,K);return}if(R&64){fe.move(E,w,I,de);return}if(fe===ln){i(J,w,I);for(let X=0;X<g.length;X++)ye(g[X],w,I,K);i(E.anchor,w,I);return}if(fe===Ps){y(E,w,I);return}if(K!==2&&R&1&&x)if(K===0)x.beforeEnter(J),i(J,w,I),Ct(()=>x.enter(J),B);else{const{leave:X,delayLeave:k,afterLeave:ue}=x,re=()=>i(J,w,I),ce=()=>{X(J,()=>{re(),ue&&ue()})};k?k(J,re,ce):ce()}else i(J,w,I)},Le=(E,w,I,K=!1,B=!1)=>{const{type:J,props:fe,ref:x,children:g,dynamicChildren:R,shapeFlag:O,patchFlag:X,dirs:k,memoIndex:ue}=E;if(x!=null&&Sa(x,null,I,E,!0),ue!=null&&(w.renderCache[ue]=void 0),O&256){w.ctx.deactivate(E);return}const re=O&1&&k,ce=!ws(E);let Se;if(ce&&(Se=fe&&fe.onVnodeBeforeUnmount)&&sn(Se,w,E),O&6)he(E.component,I,K);else{if(O&128){E.suspense.unmount(I,K);return}re&&fi(E,null,w,"beforeUnmount"),O&64?E.type.remove(E,w,I,B,de,K):R&&(J!==ln||X>0&&X&64)?ge(R,w,I,!1,!0):(J===ln&&X&384||!B&&O&16)&&ge(g,w,I),K&&ke(E)}(ce&&(Se=fe&&fe.onVnodeUnmounted)||re)&&Ct(()=>{Se&&sn(Se,w,E),re&&fi(E,null,w,"unmounted")},I)},ke=E=>{const{type:w,el:I,anchor:K,transition:B}=E;if(w===ln){ee(I,K);return}if(w===Ps){A(E);return}const J=()=>{r(I),B&&!B.persisted&&B.afterLeave&&B.afterLeave()};if(E.shapeFlag&1&&B&&!B.persisted){const{leave:fe,delayLeave:x}=B,g=()=>fe(I,J);x?x(E.el,J,g):g()}else J()},ee=(E,w)=>{let I;for(;E!==w;)I=d(E),r(E),E=I;r(w)},he=(E,w,I)=>{const{bum:K,scope:B,update:J,subTree:fe,um:x,m:g,a:R}=E;Jc(g),Jc(R),K&&Ko(K),B.stop(),J&&(J.active=!1,Le(fe,E,w,I)),x&&Ct(x,w),Ct(()=>{E.isUnmounted=!0},w),w&&w.pendingBranch&&!w.isUnmounted&&E.asyncDep&&!E.asyncResolved&&E.suspenseId===w.pendingId&&(w.deps--,w.deps===0&&w.resolve())},ge=(E,w,I,K=!1,B=!1,J=0)=>{for(let fe=J;fe<E.length;fe++)Le(E[fe],w,I,K,B)},N=E=>E.shapeFlag&6?N(E.component.subTree):E.shapeFlag&128?E.suspense.next():d(E.anchor||E.el);let ae=!1;const ne=(E,w,I)=>{E==null?w._vnode&&Le(w._vnode,null,null,!0):v(w._vnode||null,E,w,null,null,null,I),ae||(ae=!0,Hc(),Bf(),ae=!1),w._vnode=E},de={p:v,um:Le,m:ye,r:ke,mt:se,mc:H,pc:G,pbc:M,n:N,o:n};let P,we;return{render:ne,hydrate:P,createApp:Fx(ne,P)}}function jo({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function di({effect:n,update:e},t){n.allowRecurse=e.allowRecurse=t}function Wx(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function td(n,e,t=!1){const i=n.children,r=e.children;if(Be(i)&&Be(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=kn(r[s]),a.el=o.el),!t&&a.patchFlag!==-2&&td(o,a)),a.type===ao&&(a.el=o.el)}}function Xx(n){const e=n.slice(),t=[0];let i,r,s,o,a;const l=n.length;for(i=0;i<l;i++){const c=n[i];if(c!==0){if(r=t[t.length-1],n[r]<c){e[i]=r,t.push(i);continue}for(s=0,o=t.length-1;s<o;)a=s+o>>1,n[t[a]]<c?s=a+1:o=a;c<n[t[s]]&&(s>0&&(e[i]=t[s-1]),t[s]=i)}}for(s=t.length,o=t[s-1];s-- >0;)t[s]=o,o=e[o];return t}function nd(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:nd(e)}function Jc(n){if(n)for(let e=0;e<n.length;e++)n[e].active=!1}const qx=Symbol.for("v-scx"),Kx=()=>Pn(qx),Ts={};function Cs(n,e,t){return id(n,e,t)}function id(n,e,{immediate:t,deep:i,flush:r,once:s,onTrack:o,onTrigger:a}=it){if(e&&s){const C=e;e=(...L)=>{C(...L),V()}}const l=yt,c=C=>i===!0?C:xi(C,i===!1?1:void 0);let u,f=!1,d=!1;if(Ut(n)?(u=()=>n.value,f=Hs(n)):Ar(n)?(u=()=>c(n),f=!0):Be(n)?(d=!0,f=n.some(C=>Ar(C)||Hs(C)),u=()=>n.map(C=>{if(Ut(C))return C.value;if(Ar(C))return c(C);if(Ge(C))return Yn(C,l,2)})):Ge(n)?e?u=()=>Yn(n,l,2):u=()=>(p&&p(),en(n,l,3,[_])):u=Wt,e&&i){const C=u;u=()=>xi(C())}let p,_=C=>{p=y.onStop=()=>{Yn(C,l,4),p=y.onStop=void 0}},v;if(lo)if(_=Wt,e?t&&en(e,l,3,[u(),d?[]:void 0,_]):u(),r==="sync"){const C=Kx();v=C.__watcherHandles||(C.__watcherHandles=[])}else return Wt;let m=d?new Array(n.length).fill(Ts):Ts;const h=()=>{if(!(!y.active||!y.dirty))if(e){const C=y.run();(i||f||(d?C.some((L,H)=>Jn(L,m[H])):Jn(C,m)))&&(p&&p(),en(e,l,3,[C,m===Ts?void 0:d&&m[0]===Ts?[]:m,_]),m=C)}else y.run()};h.allowRecurse=!!e;let T;r==="sync"?T=h:r==="post"?T=()=>Ct(h,l&&l.suspense):(h.pre=!0,l&&(h.id=l.uid),T=()=>Ya(h));const y=new Ha(u,Wt,T),A=D0(),V=()=>{y.stop(),A&&Fa(A.effects,y)};return e?t?h():m=y.run():r==="post"?Ct(y.run.bind(y),l&&l.suspense):y.run(),v&&v.push(V),V}function Yx(n,e,t){const i=this.proxy,r=vt(n)?n.includes(".")?rd(i,n):()=>i[n]:n.bind(i,i);let s;Ge(e)?s=e:(s=e.handler,t=e);const o=Xr(this),a=id(r,s.bind(i),t);return o(),a}function rd(n,e){const t=e.split(".");return()=>{let i=n;for(let r=0;r<t.length&&i;r++)i=i[t[r]];return i}}function xi(n,e=1/0,t){if(e<=0||!at(n)||n.__v_skip||(t=t||new Set,t.has(n)))return n;if(t.add(n),e--,Ut(n))xi(n.value,e,t);else if(Be(n))for(let i=0;i<n.length;i++)xi(n[i],e,t);else if(_0(n)||Tr(n))n.forEach(i=>{xi(i,e,t)});else if(S0(n)){for(const i in n)xi(n[i],e,t);for(const i of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,i)&&xi(n[i],e,t)}return n}const sd=n=>n.type.__isKeepAlive;function $x(n,e){od(n,"a",e)}function jx(n,e){od(n,"da",e)}function od(n,e,t=yt){const i=n.__wdc||(n.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return n()});if(oo(e,i,t),t){let r=t.parent;for(;r&&r.parent;)sd(r.parent.vnode)&&Zx(i,e,t,r),r=r.parent}}function Zx(n,e,t,i){const r=oo(e,n,i,!0);kf(()=>{Fa(i[e],r)},t)}function ad(n,e){n.shapeFlag&6&&n.component?ad(n.component.subTree,e):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}const Jx=n=>n.__isTeleport,ln=Symbol.for("v-fgt"),ao=Symbol.for("v-txt"),Or=Symbol.for("v-cmt"),Ps=Symbol.for("v-stc"),Cr=[];let Qt=null;function Za(n=!1){Cr.push(Qt=n?null:[])}function Qx(){Cr.pop(),Qt=Cr[Cr.length-1]||null}let zr=1;function Qc(n){zr+=n}function eS(n){return n.dynamicChildren=zr>0?Qt||Ki:null,Qx(),zr>0&&Qt&&Qt.push(n),n}function Ja(n,e,t,i,r,s){return eS(Ot(n,e,t,i,r,s,!0))}function Ma(n){return n?n.__v_isVNode===!0:!1}function mr(n,e){return n.type===e.type&&n.key===e.key}const ld=({key:n})=>n??null,Ls=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?vt(n)||Ut(n)||Ge(n)?{i:Jt,r:n,k:e,f:!!t}:n:null);function Ot(n,e=null,t=null,i=0,r=null,s=n===ln?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&ld(e),ref:e&&Ls(e),scopeId:so,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:Jt};return a?(Qa(l,t),s&128&&n.normalize(l)):t&&(l.shapeFlag|=vt(t)?8:16),zr>0&&!o&&Qt&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&Qt.push(l),l}const gt=tS;function tS(n,e=null,t=null,i=0,r=null,s=!1){if((!n||n===gx)&&(n=Or),Ma(n)){const a=nr(n,e,!0);return t&&Qa(a,t),zr>0&&!s&&Qt&&(a.shapeFlag&6?Qt[Qt.indexOf(n)]=a:Qt.push(a)),a.patchFlag=-2,a}if(dS(n)&&(n=n.__vccOpts),e){e=nS(e);let{class:a,style:l}=e;a&&!vt(a)&&(e.class=Ba(a)),at(l)&&(Lf(l)&&!Be(l)&&(l=mt({},l)),e.style=za(l))}const o=vt(n)?1:vx(n)?128:Jx(n)?64:at(n)?4:Ge(n)?2:0;return Ot(n,e,t,i,r,o,s,!0)}function nS(n){return n?Lf(n)||$f(n)?mt({},n):n:null}function nr(n,e,t=!1,i=!1){const{props:r,ref:s,patchFlag:o,children:a,transition:l}=n,c=e?iS(r||{},e):r,u={__v_isVNode:!0,__v_skip:!0,type:n.type,props:c,key:c&&ld(c),ref:e&&e.ref?t&&s?Be(s)?s.concat(Ls(e)):[s,Ls(e)]:Ls(e):s,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:a,target:n.target,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==ln?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:l,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&nr(n.ssContent),ssFallback:n.ssFallback&&nr(n.ssFallback),el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return l&&i&&ad(u,l.clone(u)),u}function Sr(n=" ",e=0){return gt(ao,null,n,e)}function cd(n,e){const t=gt(Ps,null,n);return t.staticCount=e,t}function cn(n){return n==null||typeof n=="boolean"?gt(Or):Be(n)?gt(ln,null,n.slice()):typeof n=="object"?kn(n):gt(ao,null,String(n))}function kn(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:nr(n)}function Qa(n,e){let t=0;const{shapeFlag:i}=n;if(e==null)e=null;else if(Be(e))t=16;else if(typeof e=="object")if(i&65){const r=e.default;r&&(r._c&&(r._d=!1),Qa(n,r()),r._c&&(r._d=!0));return}else{t=32;const r=e._;!r&&!$f(e)?e._ctx=Jt:r===3&&Jt&&(Jt.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else Ge(e)?(e={default:e,_ctx:Jt},t=32):(e=String(e),i&64?(t=16,e=[Sr(e)]):t=8);n.children=e,n.shapeFlag|=t}function iS(...n){const e={};for(let t=0;t<n.length;t++){const i=n[t];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=Ba([e.class,i.class]));else if(r==="style")e.style=za([e.style,i.style]);else if(Zs(r)){const s=e[r],o=i[r];o&&s!==o&&!(Be(s)&&s.includes(o))&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function sn(n,e,t,i=null){en(n,e,7,[t,i])}const rS=qf();let sS=0;function oS(n,e,t){const i=n.type,r=(e?e.appContext:n.appContext)||rS,s={uid:sS++,vnode:n,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,scope:new P0(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Zf(i,r),emitsOptions:Vf(i,r),emit:null,emitted:null,propsDefaults:it,inheritAttrs:i.inheritAttrs,ctx:it,data:it,props:it,attrs:it,slots:it,refs:it,setupState:it,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=cx.bind(null,s),n.ce&&n.ce(s),s}let yt=null,ks,ya;{const n=gf(),e=(t,i)=>{let r;return(r=n[t])||(r=n[t]=[]),r.push(i),s=>{r.length>1?r.forEach(o=>o(s)):r[0](s)}};ks=e("__VUE_INSTANCE_SETTERS__",t=>yt=t),ya=e("__VUE_SSR_SETTERS__",t=>lo=t)}const Xr=n=>{const e=yt;return ks(n),n.scope.on(),()=>{n.scope.off(),ks(e)}},eu=()=>{yt&&yt.scope.off(),ks(null)};function ud(n){return n.vnode.shapeFlag&4}let lo=!1;function aS(n,e=!1){e&&ya(e);const{props:t,children:i}=n.vnode,r=ud(n);Ox(n,t,r,e),Hx(n,i);const s=r?lS(n,e):void 0;return e&&ya(!1),s}function lS(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Cx);const{setup:i}=t;if(i){const r=n.setupContext=i.length>1?uS(n):null,s=Xr(n);ti();const o=Yn(i,n,0,[n.props,r]);if(ni(),s(),pf(o)){if(o.then(eu,eu),e)return o.then(a=>{tu(n,a,e)}).catch(a=>{io(a,n,0)});n.asyncDep=o}else tu(n,o,e)}else fd(n,e)}function tu(n,e,t){Ge(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:at(e)&&(n.setupState=Nf(e)),fd(n,t)}let nu;function fd(n,e,t){const i=n.type;if(!n.render){if(!e&&nu&&!i.render){const r=i.template||$a(n).template;if(r){const{isCustomElement:s,compilerOptions:o}=n.appContext.config,{delimiters:a,compilerOptions:l}=i,c=mt(mt({isCustomElement:s,delimiters:a},o),l);i.render=nu(r,c)}}n.render=i.render||Wt}{const r=Xr(n);ti();try{Px(n)}finally{ni(),r()}}}const cS={get(n,e){return Dt(n,"get",""),n[e]}};function uS(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,cS),slots:n.slots,emit:n.emit,expose:e}}function el(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(Nf(J0(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in wr)return wr[t](n)},has(e,t){return t in e||t in wr}})):n.proxy}function fS(n,e=!0){return Ge(n)?n.displayName||n.name:n.name||e&&n.__name}function dS(n){return Ge(n)&&"__vccOpts"in n}const jt=(n,e)=>Q0(n,e,lo);function dd(n,e,t){const i=arguments.length;return i===2?at(e)&&!Be(e)?Ma(e)?gt(n,null,[e]):gt(n,e):gt(n,null,e):(i>3?t=Array.prototype.slice.call(arguments,2):i===3&&Ma(t)&&(t=[t]),gt(n,e,t))}const hS="3.4.29";/**
* @vue/runtime-dom v3.4.29
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const pS="http://www.w3.org/2000/svg",mS="http://www.w3.org/1998/Math/MathML",En=typeof document<"u"?document:null,iu=En&&En.createElement("template"),gS={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,i)=>{const r=e==="svg"?En.createElementNS(pS,n):e==="mathml"?En.createElementNS(mS,n):t?En.createElement(n,{is:t}):En.createElement(n);return n==="select"&&i&&i.multiple!=null&&r.setAttribute("multiple",i.multiple),r},createText:n=>En.createTextNode(n),createComment:n=>En.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>En.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,i,r,s){const o=t?t.previousSibling:e.lastChild;if(r&&(r===s||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),t),!(r===s||!(r=r.nextSibling)););else{iu.innerHTML=i==="svg"?`<svg>${n}</svg>`:i==="mathml"?`<math>${n}</math>`:n;const a=iu.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},_S=Symbol("_vtc");function vS(n,e,t){const i=n[_S];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const ru=Symbol("_vod"),xS=Symbol("_vsh"),SS=Symbol(""),MS=/(^|;)\s*display\s*:/;function yS(n,e,t){const i=n.style,r=vt(t);let s=!1;if(t&&!r){if(e)if(vt(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();t[a]==null&&Ds(i,a,"")}else for(const o in e)t[o]==null&&Ds(i,o,"");for(const o in t)o==="display"&&(s=!0),Ds(i,o,t[o])}else if(r){if(e!==t){const o=i[SS];o&&(t+=";"+o),i.cssText=t,s=MS.test(t)}}else e&&n.removeAttribute("style");ru in n&&(n[ru]=s?i.display:"",n[xS]&&(i.display="none"))}const su=/\s*!important$/;function Ds(n,e,t){if(Be(t))t.forEach(i=>Ds(n,e,i));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const i=ES(n,e);su.test(t)?n.setProperty(ur(i),t.replace(su,""),"important"):n[i]=t}}const ou=["Webkit","Moz","ms"],Zo={};function ES(n,e){const t=Zo[e];if(t)return t;let i=pn(e);if(i!=="filter"&&i in n)return Zo[e]=i;i=eo(i);for(let r=0;r<ou.length;r++){const s=ou[r]+i;if(s in n)return Zo[e]=s}return e}const au="http://www.w3.org/1999/xlink";function lu(n,e,t,i,r,s=C0(e)){i&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(au,e.slice(6,e.length)):n.setAttributeNS(au,e,t):t==null||s&&!_f(t)?n.removeAttribute(e):n.setAttribute(e,s?"":String(t))}function TS(n,e,t,i,r,s,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,r,s),n[e]=t??"";return}const a=n.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){const c=a==="OPTION"?n.getAttribute("value")||"":n.value,u=t==null?"":String(t);(c!==u||!("_value"in n))&&(n.value=u),t==null&&n.removeAttribute(e),n._value=t;return}let l=!1;if(t===""||t==null){const c=typeof n[e];c==="boolean"?t=_f(t):t==null&&c==="string"?(t="",l=!0):c==="number"&&(t=0,l=!0)}try{n[e]=t}catch{}l&&n.removeAttribute(e)}function bS(n,e,t,i){n.addEventListener(e,t,i)}function AS(n,e,t,i){n.removeEventListener(e,t,i)}const cu=Symbol("_vei");function wS(n,e,t,i,r=null){const s=n[cu]||(n[cu]={}),o=s[e];if(i&&o)o.value=i;else{const[a,l]=RS(e);if(i){const c=s[e]=LS(i,r);bS(n,a,c,l)}else o&&(AS(n,a,o,l),s[e]=void 0)}}const uu=/(?:Once|Passive|Capture)$/;function RS(n){let e;if(uu.test(n)){e={};let i;for(;i=n.match(uu);)n=n.slice(0,n.length-i[0].length),e[i[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):ur(n.slice(2)),e]}let Jo=0;const CS=Promise.resolve(),PS=()=>Jo||(CS.then(()=>Jo=0),Jo=Date.now());function LS(n,e){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;en(DS(i,t.value),e,5,[i])};return t.value=n,t.attached=PS(),t}function DS(n,e){if(Be(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(i=>r=>!r._stopped&&i&&i(r))}else return e}const fu=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,US=(n,e,t,i,r,s,o,a,l)=>{const c=r==="svg";e==="class"?vS(n,i,c):e==="style"?yS(n,t,i):Zs(e)?Na(e)||wS(n,e,t,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):IS(n,e,i,c))?(TS(n,e,i,s,o,a,l),(e==="value"||e==="checked"||e==="selected")&&lu(n,e,i,c,o,e!=="value")):(e==="true-value"?n._trueValue=i:e==="false-value"&&(n._falseValue=i),lu(n,e,i,c))};function IS(n,e,t,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in n&&fu(e)&&Ge(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=n.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return fu(e)&&vt(t)?!1:e in n}const NS=mt({patchProp:US},gS);let du;function FS(){return du||(du=Gx(NS))}const OS=(...n)=>{const e=FS().createApp(...n),{mount:t}=e;return e.mount=i=>{const r=BS(i);if(!r)return;const s=e._component;!Ge(s)&&!s.render&&!s.template&&(s.template=r.innerHTML),r.innerHTML="";const o=t(r,!1,zS(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function zS(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function BS(n){return vt(n)?document.querySelector(n):n}const qr=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},HS={},VS=n=>(ux("data-v-0215fad1"),n=n(),fx(),n),GS={class:"red-hat-display-semibold"},kS={class:"monumentextended-black"},WS=VS(()=>Ot("div",{class:"subtitle monumentextended-black"},"{Designer and Developer}",-1)),XS={id:"router-view-section"};function qS(n,e){const t=Gc("RouterLink"),i=Gc("RouterView");return Za(),Ja(ln,null,[Ot("header",null,[Ot("nav",GS,[Ot("ul",null,[Ot("li",null,[gt(t,{to:"/about-me"},{default:vr(()=>[Sr("About_me_")]),_:1})]),Ot("li",null,[gt(t,{to:"/projects"},{default:vr(()=>[Sr("Projects_")]),_:1})]),Ot("li",null,[gt(t,{to:"/contact"},{default:vr(()=>[Sr("Contact_")]),_:1})])])])]),Ot("main",null,[Ot("header",null,[Ot("h1",kS,[gt(t,{to:"/","active-class":"home-link-active",class:"home-link"},{default:vr(()=>[Sr(" Krystian Jasionek "),WS]),_:1})])]),Ot("section",XS,[gt(i)])])],64)}const KS=qr(HS,[["render",qS],["__scopeId","data-v-0215fad1"]]);/*!
  * vue-router v4.3.3
  * (c) 2024 Eduardo San Martin Morote
  * @license MIT
  */const Gi=typeof document<"u";function YS(n){return n.__esModule||n[Symbol.toStringTag]==="Module"}const nt=Object.assign;function Qo(n,e){const t={};for(const i in e){const r=e[i];t[i]=tn(r)?r.map(n):n(r)}return t}const Pr=()=>{},tn=Array.isArray,hd=/#/g,$S=/&/g,jS=/\//g,ZS=/=/g,JS=/\?/g,pd=/\+/g,QS=/%5B/g,eM=/%5D/g,md=/%5E/g,tM=/%60/g,gd=/%7B/g,nM=/%7C/g,_d=/%7D/g,iM=/%20/g;function tl(n){return encodeURI(""+n).replace(nM,"|").replace(QS,"[").replace(eM,"]")}function rM(n){return tl(n).replace(gd,"{").replace(_d,"}").replace(md,"^")}function Ea(n){return tl(n).replace(pd,"%2B").replace(iM,"+").replace(hd,"%23").replace($S,"%26").replace(tM,"`").replace(gd,"{").replace(_d,"}").replace(md,"^")}function sM(n){return Ea(n).replace(ZS,"%3D")}function oM(n){return tl(n).replace(hd,"%23").replace(JS,"%3F")}function aM(n){return n==null?"":oM(n).replace(jS,"%2F")}function Br(n){try{return decodeURIComponent(""+n)}catch{}return""+n}const lM=/\/$/,cM=n=>n.replace(lM,"");function ea(n,e,t="/"){let i,r={},s="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(i=e.slice(0,l),s=e.slice(l+1,a>-1?a:e.length),r=n(s)),a>-1&&(i=i||e.slice(0,a),o=e.slice(a,e.length)),i=hM(i??e,t),{fullPath:i+(s&&"?")+s+o,path:i,query:r,hash:Br(o)}}function uM(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function fM(n,e,t){const i=e.matched.length-1,r=t.matched.length-1;return i>-1&&i===r&&ir(e.matched[i],t.matched[r])&&vd(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function ir(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function vd(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(const t in n)if(!dM(n[t],e[t]))return!1;return!0}function dM(n,e){return tn(n)?hu(n,e):tn(e)?hu(e,n):n===e}function hu(n,e){return tn(e)?n.length===e.length&&n.every((t,i)=>t===e[i]):n.length===1&&n[0]===e}function hM(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),i=n.split("/"),r=i[i.length-1];(r===".."||r===".")&&i.push("");let s=t.length-1,o,a;for(o=0;o<i.length;o++)if(a=i[o],a!==".")if(a==="..")s>1&&s--;else break;return t.slice(0,s).join("/")+"/"+i.slice(o).join("/")}var Hr;(function(n){n.pop="pop",n.push="push"})(Hr||(Hr={}));var Ws;(function(n){n.back="back",n.forward="forward",n.unknown=""})(Ws||(Ws={}));const ta="";function pM(n){if(!n)if(Gi){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),cM(n)}const mM=/^[^#]+#/;function gM(n,e){return n.replace(mM,"#")+e}function _M(n,e){const t=document.documentElement.getBoundingClientRect(),i=n.getBoundingClientRect();return{behavior:e.behavior,left:i.left-t.left-(e.left||0),top:i.top-t.top-(e.top||0)}}const vM=()=>({left:window.scrollX,top:window.scrollY});function xM(n){let e;if("el"in n){const t=n.el,i=typeof t=="string"&&t.startsWith("#"),r=typeof t=="string"?i?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!r)return;e=_M(r,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function pu(n,e){return(history.state?history.state.position-e:-1)+n}const Ta=new Map;function SM(n,e){Ta.set(n,e)}function MM(n){const e=Ta.get(n);return Ta.delete(n),e}function yM(n=""){let e=[],t=[ta],i=0;n=pM(n);function r(a){i++,i!==t.length&&t.splice(i),t.push(a)}function s(a,l,{direction:c,delta:u}){const f={direction:c,delta:u,type:Hr.pop};for(const d of e)d(a,l,f)}const o={location:ta,state:{},base:n,createHref:gM.bind(null,n),replace(a){t.splice(i--,1),r(a)},push(a,l){r(a)},listen(a){return e.push(a),()=>{const l=e.indexOf(a);l>-1&&e.splice(l,1)}},destroy(){e=[],t=[ta],i=0},go(a,l=!0){const c=this.location,u=a<0?Ws.back:Ws.forward;i=Math.max(0,Math.min(i+a,t.length-1)),l&&s(this.location,c,{direction:u,delta:a})}};return Object.defineProperty(o,"location",{enumerable:!0,get:()=>t[i]}),o}function EM(n){return typeof n=="string"||n&&typeof n=="object"}function xd(n){return typeof n=="string"||typeof n=="symbol"}const Vn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Sd=Symbol("");var mu;(function(n){n[n.aborted=4]="aborted",n[n.cancelled=8]="cancelled",n[n.duplicated=16]="duplicated"})(mu||(mu={}));function rr(n,e){return nt(new Error,{type:n,[Sd]:!0},e)}function Mn(n,e){return n instanceof Error&&Sd in n&&(e==null||!!(n.type&e))}const gu="[^/]+?",TM={sensitive:!1,strict:!1,start:!0,end:!0},bM=/[.+*?^${}()[\]/\\]/g;function AM(n,e){const t=nt({},TM,e),i=[];let r=t.start?"^":"";const s=[];for(const c of n){const u=c.length?[]:[90];t.strict&&!c.length&&(r+="/");for(let f=0;f<c.length;f++){const d=c[f];let p=40+(t.sensitive?.25:0);if(d.type===0)f||(r+="/"),r+=d.value.replace(bM,"\\$&"),p+=40;else if(d.type===1){const{value:_,repeatable:v,optional:m,regexp:h}=d;s.push({name:_,repeatable:v,optional:m});const T=h||gu;if(T!==gu){p+=10;try{new RegExp(`(${T})`)}catch(A){throw new Error(`Invalid custom RegExp for param "${_}" (${T}): `+A.message)}}let y=v?`((?:${T})(?:/(?:${T}))*)`:`(${T})`;f||(y=m&&c.length<2?`(?:/${y})`:"/"+y),m&&(y+="?"),r+=y,p+=20,m&&(p+=-8),v&&(p+=-20),T===".*"&&(p+=-50)}u.push(p)}i.push(u)}if(t.strict&&t.end){const c=i.length-1;i[c][i[c].length-1]+=.7000000000000001}t.strict||(r+="/?"),t.end?r+="$":t.strict&&(r+="(?:/|$)");const o=new RegExp(r,t.sensitive?"":"i");function a(c){const u=c.match(o),f={};if(!u)return null;for(let d=1;d<u.length;d++){const p=u[d]||"",_=s[d-1];f[_.name]=p&&_.repeatable?p.split("/"):p}return f}function l(c){let u="",f=!1;for(const d of n){(!f||!u.endsWith("/"))&&(u+="/"),f=!1;for(const p of d)if(p.type===0)u+=p.value;else if(p.type===1){const{value:_,repeatable:v,optional:m}=p,h=_ in c?c[_]:"";if(tn(h)&&!v)throw new Error(`Provided param "${_}" is an array but it is not repeatable (* or + modifiers)`);const T=tn(h)?h.join("/"):h;if(!T)if(m)d.length<2&&(u.endsWith("/")?u=u.slice(0,-1):f=!0);else throw new Error(`Missing required param "${_}"`);u+=T}}return u||"/"}return{re:o,score:i,keys:s,parse:a,stringify:l}}function wM(n,e){let t=0;for(;t<n.length&&t<e.length;){const i=e[t]-n[t];if(i)return i;t++}return n.length<e.length?n.length===1&&n[0]===80?-1:1:n.length>e.length?e.length===1&&e[0]===80?1:-1:0}function Md(n,e){let t=0;const i=n.score,r=e.score;for(;t<i.length&&t<r.length;){const s=wM(i[t],r[t]);if(s)return s;t++}if(Math.abs(r.length-i.length)===1){if(_u(i))return 1;if(_u(r))return-1}return r.length-i.length}function _u(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const RM={type:0,value:""},CM=/[a-zA-Z0-9_]/;function PM(n){if(!n)return[[]];if(n==="/")return[[RM]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e(p){throw new Error(`ERR (${t})/"${c}": ${p}`)}let t=0,i=t;const r=[];let s;function o(){s&&r.push(s),s=[]}let a=0,l,c="",u="";function f(){c&&(t===0?s.push({type:0,value:c}):t===1||t===2||t===3?(s.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function d(){c+=l}for(;a<n.length;){if(l=n[a++],l==="\\"&&t!==2){i=t,t=4;continue}switch(t){case 0:l==="/"?(c&&f(),o()):l===":"?(f(),t=1):d();break;case 4:d(),t=i;break;case 1:l==="("?t=2:CM.test(l)?d():(f(),t=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:t=3:u+=l;break;case 3:f(),t=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,u="";break;default:e("Unknown state");break}}return t===2&&e(`Unfinished custom RegExp for param "${c}"`),f(),o(),r}function LM(n,e,t){const i=AM(PM(n.path),t),r=nt(i,{record:n,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function DM(n,e){const t=[],i=new Map;e=Su({strict:!1,end:!0,sensitive:!1},e);function r(u){return i.get(u)}function s(u,f,d){const p=!d,_=UM(u);_.aliasOf=d&&d.record;const v=Su(e,u),m=[_];if("alias"in u){const y=typeof u.alias=="string"?[u.alias]:u.alias;for(const A of y)m.push(nt({},_,{components:d?d.record.components:_.components,path:A,aliasOf:d?d.record:_}))}let h,T;for(const y of m){const{path:A}=y;if(f&&A[0]!=="/"){const V=f.record.path,C=V[V.length-1]==="/"?"":"/";y.path=f.record.path+(A&&C+A)}if(h=LM(y,f,v),d?d.alias.push(h):(T=T||h,T!==h&&T.alias.push(h),p&&u.name&&!xu(h)&&o(u.name)),yd(h)&&l(h),_.children){const V=_.children;for(let C=0;C<V.length;C++)s(V[C],h,d&&d.children[C])}d=d||h}return T?()=>{o(T)}:Pr}function o(u){if(xd(u)){const f=i.get(u);f&&(i.delete(u),t.splice(t.indexOf(f),1),f.children.forEach(o),f.alias.forEach(o))}else{const f=t.indexOf(u);f>-1&&(t.splice(f,1),u.record.name&&i.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return t}function l(u){const f=FM(u,t);t.splice(f,0,u),u.record.name&&!xu(u)&&i.set(u.record.name,u)}function c(u,f){let d,p={},_,v;if("name"in u&&u.name){if(d=i.get(u.name),!d)throw rr(1,{location:u});v=d.record.name,p=nt(vu(f.params,d.keys.filter(T=>!T.optional).concat(d.parent?d.parent.keys.filter(T=>T.optional):[]).map(T=>T.name)),u.params&&vu(u.params,d.keys.map(T=>T.name))),_=d.stringify(p)}else if(u.path!=null)_=u.path,d=t.find(T=>T.re.test(_)),d&&(p=d.parse(_),v=d.record.name);else{if(d=f.name?i.get(f.name):t.find(T=>T.re.test(f.path)),!d)throw rr(1,{location:u,currentLocation:f});v=d.record.name,p=nt({},f.params,u.params),_=d.stringify(p)}const m=[];let h=d;for(;h;)m.unshift(h.record),h=h.parent;return{name:v,path:_,params:p,matched:m,meta:NM(m)}}return n.forEach(u=>s(u)),{addRoute:s,resolve:c,removeRoute:o,getRoutes:a,getRecordMatcher:r}}function vu(n,e){const t={};for(const i of e)i in n&&(t[i]=n[i]);return t}function UM(n){return{path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:void 0,beforeEnter:n.beforeEnter,props:IM(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}}}function IM(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const i in n.components)e[i]=typeof t=="object"?t[i]:t;return e}function xu(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function NM(n){return n.reduce((e,t)=>nt(e,t.meta),{})}function Su(n,e){const t={};for(const i in n)t[i]=i in e?e[i]:n[i];return t}function FM(n,e){let t=0,i=e.length;for(;t!==i;){const s=t+i>>1;Md(n,e[s])<0?i=s:t=s+1}const r=OM(n);return r&&(i=e.lastIndexOf(r,i-1)),i}function OM(n){let e=n;for(;e=e.parent;)if(yd(e)&&Md(n,e)===0)return e}function yd({record:n}){return!!(n.name||n.components&&Object.keys(n.components).length||n.redirect)}function zM(n){const e={};if(n===""||n==="?")return e;const i=(n[0]==="?"?n.slice(1):n).split("&");for(let r=0;r<i.length;++r){const s=i[r].replace(pd," "),o=s.indexOf("="),a=Br(o<0?s:s.slice(0,o)),l=o<0?null:Br(s.slice(o+1));if(a in e){let c=e[a];tn(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function Mu(n){let e="";for(let t in n){const i=n[t];if(t=sM(t),i==null){i!==void 0&&(e+=(e.length?"&":"")+t);continue}(tn(i)?i.map(s=>s&&Ea(s)):[i&&Ea(i)]).forEach(s=>{s!==void 0&&(e+=(e.length?"&":"")+t,s!=null&&(e+="="+s))})}return e}function BM(n){const e={};for(const t in n){const i=n[t];i!==void 0&&(e[t]=tn(i)?i.map(r=>r==null?null:""+r):i==null?i:""+i)}return e}const HM=Symbol(""),yu=Symbol(""),nl=Symbol(""),Ed=Symbol(""),ba=Symbol("");function gr(){let n=[];function e(i){return n.push(i),()=>{const r=n.indexOf(i);r>-1&&n.splice(r,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function Wn(n,e,t,i,r,s=o=>o()){const o=i&&(i.enterCallbacks[r]=i.enterCallbacks[r]||[]);return()=>new Promise((a,l)=>{const c=d=>{d===!1?l(rr(4,{from:t,to:e})):d instanceof Error?l(d):EM(d)?l(rr(2,{from:e,to:d})):(o&&i.enterCallbacks[r]===o&&typeof d=="function"&&o.push(d),a())},u=s(()=>n.call(i&&i.instances[r],e,t,c));let f=Promise.resolve(u);n.length<3&&(f=f.then(c)),f.catch(d=>l(d))})}function na(n,e,t,i,r=s=>s()){const s=[];for(const o of n)for(const a in o.components){let l=o.components[a];if(!(e!=="beforeRouteEnter"&&!o.instances[a]))if(VM(l)){const u=(l.__vccOpts||l)[e];u&&s.push(Wn(u,t,i,o,a,r))}else{let c=l();s.push(()=>c.then(u=>{if(!u)return Promise.reject(new Error(`Couldn't resolve component "${a}" at "${o.path}"`));const f=YS(u)?u.default:u;o.components[a]=f;const p=(f.__vccOpts||f)[e];return p&&Wn(p,t,i,o,a,r)()}))}}return s}function VM(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function Eu(n){const e=Pn(nl),t=Pn(Ed),i=jt(()=>{const l=Yi(n.to);return e.resolve(l)}),r=jt(()=>{const{matched:l}=i.value,{length:c}=l,u=l[c-1],f=t.matched;if(!u||!f.length)return-1;const d=f.findIndex(ir.bind(null,u));if(d>-1)return d;const p=Tu(l[c-2]);return c>1&&Tu(u)===p&&f[f.length-1].path!==p?f.findIndex(ir.bind(null,l[c-2])):d}),s=jt(()=>r.value>-1&&XM(t.params,i.value.params)),o=jt(()=>r.value>-1&&r.value===t.matched.length-1&&vd(t.params,i.value.params));function a(l={}){return WM(l)?e[Yi(n.replace)?"replace":"push"](Yi(n.to)).catch(Pr):Promise.resolve()}return{route:i,href:jt(()=>i.value.href),isActive:s,isExactActive:o,navigate:a}}const GM=Wf({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Eu,setup(n,{slots:e}){const t=no(Eu(n)),{options:i}=Pn(nl),r=jt(()=>({[bu(n.activeClass,i.linkActiveClass,"router-link-active")]:t.isActive,[bu(n.exactActiveClass,i.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const s=e.default&&e.default(t);return n.custom?s:dd("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:r.value},s)}}}),kM=GM;function WM(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function XM(n,e){for(const t in e){const i=e[t],r=n[t];if(typeof i=="string"){if(i!==r)return!1}else if(!tn(r)||r.length!==i.length||i.some((s,o)=>s!==r[o]))return!1}return!0}function Tu(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const bu=(n,e,t)=>n??e??t,qM=Wf({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const i=Pn(ba),r=jt(()=>n.route||i.value),s=Pn(yu,0),o=jt(()=>{let c=Yi(s);const{matched:u}=r.value;let f;for(;(f=u[c])&&!f.components;)c++;return c}),a=jt(()=>r.value.matched[o.value]);Rs(yu,jt(()=>o.value+1)),Rs(HM,a),Rs(ba,r);const l=ex();return Cs(()=>[l.value,a.value,n.name],([c,u,f],[d,p,_])=>{u&&(u.instances[f]=c,p&&p!==u&&c&&c===d&&(u.leaveGuards.size||(u.leaveGuards=p.leaveGuards),u.updateGuards.size||(u.updateGuards=p.updateGuards))),c&&u&&(!p||!ir(u,p)||!d)&&(u.enterCallbacks[f]||[]).forEach(v=>v(c))},{flush:"post"}),()=>{const c=r.value,u=n.name,f=a.value,d=f&&f.components[u];if(!d)return Au(t.default,{Component:d,route:c});const p=f.props[u],_=p?p===!0?c.params:typeof p=="function"?p(c):p:null,m=dd(d,nt({},_,e,{onVnodeUnmounted:h=>{h.component.isUnmounted&&(f.instances[u]=null)},ref:l}));return Au(t.default,{Component:m,route:c})||m}}});function Au(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const KM=qM;function YM(n){const e=DM(n.routes,n),t=n.parseQuery||zM,i=n.stringifyQuery||Mu,r=n.history,s=gr(),o=gr(),a=gr(),l=tx(Vn);let c=Vn;Gi&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Qo.bind(null,N=>""+N),f=Qo.bind(null,aM),d=Qo.bind(null,Br);function p(N,ae){let ne,de;return xd(N)?(ne=e.getRecordMatcher(N),de=ae):de=N,e.addRoute(de,ne)}function _(N){const ae=e.getRecordMatcher(N);ae&&e.removeRoute(ae)}function v(){return e.getRoutes().map(N=>N.record)}function m(N){return!!e.getRecordMatcher(N)}function h(N,ae){if(ae=nt({},ae||l.value),typeof N=="string"){const w=ea(t,N,ae.path),I=e.resolve({path:w.path},ae),K=r.createHref(w.fullPath);return nt(w,I,{params:d(I.params),hash:Br(w.hash),redirectedFrom:void 0,href:K})}let ne;if(N.path!=null)ne=nt({},N,{path:ea(t,N.path,ae.path).path});else{const w=nt({},N.params);for(const I in w)w[I]==null&&delete w[I];ne=nt({},N,{params:f(w)}),ae.params=f(ae.params)}const de=e.resolve(ne,ae),P=N.hash||"";de.params=u(d(de.params));const we=uM(i,nt({},N,{hash:rM(P),path:de.path})),E=r.createHref(we);return nt({fullPath:we,hash:P,query:i===Mu?BM(N.query):N.query||{}},de,{redirectedFrom:void 0,href:E})}function T(N){return typeof N=="string"?ea(t,N,l.value.path):nt({},N)}function y(N,ae){if(c!==N)return rr(8,{from:ae,to:N})}function A(N){return L(N)}function V(N){return A(nt(T(N),{replace:!0}))}function C(N){const ae=N.matched[N.matched.length-1];if(ae&&ae.redirect){const{redirect:ne}=ae;let de=typeof ne=="function"?ne(N):ne;return typeof de=="string"&&(de=de.includes("?")||de.includes("#")?de=T(de):{path:de},de.params={}),nt({query:N.query,hash:N.hash,params:de.path!=null?{}:N.params},de)}}function L(N,ae){const ne=c=h(N),de=l.value,P=N.state,we=N.force,E=N.replace===!0,w=C(ne);if(w)return L(nt(T(w),{state:typeof w=="object"?nt({},P,w.state):P,force:we,replace:E}),ae||ne);const I=ne;I.redirectedFrom=ae;let K;return!we&&fM(i,de,ne)&&(K=rr(16,{to:I,from:de}),ye(de,de,!0,!1)),(K?Promise.resolve(K):M(I,de)).catch(B=>Mn(B)?Mn(B,2)?B:Me(B):G(B,I,de)).then(B=>{if(B){if(Mn(B,2))return L(nt({replace:E},T(B.to),{state:typeof B.to=="object"?nt({},P,B.to.state):P,force:we}),ae||I)}else B=Q(I,de,!0,E,P);return U(I,de,B),B})}function H(N,ae){const ne=y(N,ae);return ne?Promise.reject(ne):Promise.resolve()}function b(N){const ae=ee.values().next().value;return ae&&typeof ae.runWithContext=="function"?ae.runWithContext(N):N()}function M(N,ae){let ne;const[de,P,we]=$M(N,ae);ne=na(de.reverse(),"beforeRouteLeave",N,ae);for(const w of de)w.leaveGuards.forEach(I=>{ne.push(Wn(I,N,ae))});const E=H.bind(null,N,ae);return ne.push(E),ge(ne).then(()=>{ne=[];for(const w of s.list())ne.push(Wn(w,N,ae));return ne.push(E),ge(ne)}).then(()=>{ne=na(P,"beforeRouteUpdate",N,ae);for(const w of P)w.updateGuards.forEach(I=>{ne.push(Wn(I,N,ae))});return ne.push(E),ge(ne)}).then(()=>{ne=[];for(const w of we)if(w.beforeEnter)if(tn(w.beforeEnter))for(const I of w.beforeEnter)ne.push(Wn(I,N,ae));else ne.push(Wn(w.beforeEnter,N,ae));return ne.push(E),ge(ne)}).then(()=>(N.matched.forEach(w=>w.enterCallbacks={}),ne=na(we,"beforeRouteEnter",N,ae,b),ne.push(E),ge(ne))).then(()=>{ne=[];for(const w of o.list())ne.push(Wn(w,N,ae));return ne.push(E),ge(ne)}).catch(w=>Mn(w,8)?w:Promise.reject(w))}function U(N,ae,ne){a.list().forEach(de=>b(()=>de(N,ae,ne)))}function Q(N,ae,ne,de,P){const we=y(N,ae);if(we)return we;const E=ae===Vn,w=Gi?history.state:{};ne&&(de||E?r.replace(N.fullPath,nt({scroll:E&&w&&w.scroll},P)):r.push(N.fullPath,P)),l.value=N,ye(N,ae,ne,E),Me()}let Y;function se(){Y||(Y=r.listen((N,ae,ne)=>{if(!he.listening)return;const de=h(N),P=C(de);if(P){L(nt(P,{replace:!0}),de).catch(Pr);return}c=de;const we=l.value;Gi&&SM(pu(we.fullPath,ne.delta),vM()),M(de,we).catch(E=>Mn(E,12)?E:Mn(E,2)?(L(E.to,de).then(w=>{Mn(w,20)&&!ne.delta&&ne.type===Hr.pop&&r.go(-1,!1)}).catch(Pr),Promise.reject()):(ne.delta&&r.go(-ne.delta,!1),G(E,de,we))).then(E=>{E=E||Q(de,we,!1),E&&(ne.delta&&!Mn(E,8)?r.go(-ne.delta,!1):ne.type===Hr.pop&&Mn(E,20)&&r.go(-1,!1)),U(de,we,E)}).catch(Pr)}))}let ie=gr(),j=gr(),Z;function G(N,ae,ne){Me(N);const de=j.list();return de.length?de.forEach(P=>P(N,ae,ne)):console.error(N),Promise.reject(N)}function xe(){return Z&&l.value!==Vn?Promise.resolve():new Promise((N,ae)=>{ie.add([N,ae])})}function Me(N){return Z||(Z=!N,se(),ie.list().forEach(([ae,ne])=>N?ne(N):ae()),ie.reset()),N}function ye(N,ae,ne,de){const{scrollBehavior:P}=n;if(!Gi||!P)return Promise.resolve();const we=!ne&&MM(pu(N.fullPath,0))||(de||!ne)&&history.state&&history.state.scroll||null;return Of().then(()=>P(N,ae,we)).then(E=>E&&xM(E)).catch(E=>G(E,N,ae))}const Le=N=>r.go(N);let ke;const ee=new Set,he={currentRoute:l,listening:!0,addRoute:p,removeRoute:_,hasRoute:m,getRoutes:v,resolve:h,options:n,push:A,replace:V,go:Le,back:()=>Le(-1),forward:()=>Le(1),beforeEach:s.add,beforeResolve:o.add,afterEach:a.add,onError:j.add,isReady:xe,install(N){const ae=this;N.component("RouterLink",kM),N.component("RouterView",KM),N.config.globalProperties.$router=ae,Object.defineProperty(N.config.globalProperties,"$route",{enumerable:!0,get:()=>Yi(l)}),Gi&&!ke&&l.value===Vn&&(ke=!0,A(r.location).catch(P=>{}));const ne={};for(const P in Vn)Object.defineProperty(ne,P,{get:()=>l.value[P],enumerable:!0});N.provide(nl,ae),N.provide(Ed,Cf(ne)),N.provide(ba,l);const de=N.unmount;ee.add(N),N.unmount=function(){ee.delete(N),ee.size<1&&(c=Vn,Y&&Y(),Y=null,l.value=Vn,ke=!1,Z=!1),de()}}};function ge(N){return N.reduce((ae,ne)=>ae.then(()=>b(ne)),Promise.resolve())}return he}function $M(n,e){const t=[],i=[],r=[],s=Math.max(e.matched.length,n.matched.length);for(let o=0;o<s;o++){const a=e.matched[o];a&&(n.matched.find(c=>ir(c,a))?i.push(a):t.push(a));const l=n.matched[o];l&&(e.matched.find(c=>ir(c,l))||r.push(l))}return[t,i,r]}const jM="/portfolio/assets/cv-morda-CKzvgHz1.png",ZM={},JM=cd('<header data-v-3bd1e6b1><img src="'+jM+'" data-v-3bd1e6b1><h2 data-v-3bd1e6b1>Hi, Krystian here ;)</h2></header><section data-v-3bd1e6b1><p data-v-3bd1e6b1>I profoundly believe that beautiful design and good design are the same thing. As a designer and developer I strive to create the most visually pleasing and ergonomic interfaces possible.</p><p data-v-3bd1e6b1>For web development my preferred tools are <a href="https://vuejs.org/" data-v-3bd1e6b1>Vue.js</a> and <a href="https://sass-lang.com/" data-v-3bd1e6b1>Sass</a>. Most of my recent projects have been built using these technologies. I&#39;m also experienced with <a href="https://react.dev/" data-v-3bd1e6b1>React</a> and <a href="https://tailwindcss.com/" data-v-3bd1e6b1>TailwindCSS</a>. </p><p data-v-3bd1e6b1>I&#39;m the founder and developer of a small indie game studio called Kiki/Bouba. Our common belief is that games can be a form of art, and we aim to create experiences that are both emotionally engaging and provide satisfying gameplay. We also design and develop various web applications in the spirit of the FOSS philosophy. However, recognizing the shortcomings of many FOSS projects, such as uninteresting visuals and inferior interfaces, we strive to elevate user experience through engaging, aesthetic designs and a strong focus on ergonomics and functionality. </p><p data-v-3bd1e6b1>In addition to developing and designing, I&#39;m an aspiring writer currently working on a fantasy novel. Recently, I have picked up an interest in analog photography and returned to songwriting and playing instruments.</p><p data-v-3bd1e6b1>Growing up in the rural areas of Upper Silesia, I developed a fondness for nature, especially mountains. Activities like hiking, climbing, running, and biking in green scenery make my heart race with joy.</p></section>',2),QM=[JM];function ey(n,e,t,i,r,s){return Za(),Ja("article",null,QM)}const ty=qr(ZM,[["render",ey],["__scopeId","data-v-3bd1e6b1"]]),ny={},iy=cd('<header data-v-2f22cdb5><h2 data-v-2f22cdb5>If you want to have a talk with me or take a look at my projects, feel free to reach out on these platforms:</h2></header><address data-v-2f22cdb5><div class="socials" data-v-2f22cdb5><a href="mailto:krystian.jasionek@protonmail.com" data-v-2f22cdb5><p data-v-2f22cdb5><i class="fa-regular fa-envelope" data-v-2f22cdb5></i> krystian.jasionek@protonmail.com </p></a><a href="https://github.com/Sztakler" target="_blank" data-v-2f22cdb5><p data-v-2f22cdb5><i class="fab fa-github" data-v-2f22cdb5></i> Metarth</p></a></div><footer data-v-2f22cdb5><h2 data-v-2f22cdb5>I currently live in:</h2><a href="https://www.openstreetmap.org/#map=12/51.1264/16.9488" target="_blank" data-v-2f22cdb5><p data-v-2f22cdb5><i class="fa-regular fa-map" data-v-2f22cdb5></i> Wrocław, Poland</p></a></footer></address>',2),ry=[iy];function sy(n,e,t,i,r,s){return Za(),Ja("article",null,ry)}const oy=qr(ny,[["render",sy],["__scopeId","data-v-2f22cdb5"]]),ay={};function ly(n,e,t,i,r,s){return null}const cy=qr(ay,[["render",ly]]),uy={};function fy(n,e,t,i,r,s){return null}const dy=qr(uy,[["render",fy]]);let Lr,ia,mi,Mr,wu,Aa,Ru;const wa=new t0;function hy(){return`
        varying vec3 vUv;
  ...
  float pnoise(vec3 P, vec3 rep)
{
  ...
  return 2.2 * n_xyz;
      ...
      `}my();function my(){Lr=new kt(70,window.innerWidth/window.innerHeight,.1,100),Lr.position.z=2,ia=new Zv;let n={colorB:{type:"vec3",value:new Ye(11319013)},colorA:{type:"vec3",value:new Ye(7662549)},time:{type:"f",value:wa.getDelta()}};Ru=new ar(10,10,1),Aa=new Bt({uniforms:n,fragmentShader:py(),vertexShader:hy()}),wu=new Zt(Ru,Aa),ia.add(wu),mi=new jv({antialias:!0}),mi.setPixelRatio(window.devicePixelRatio),mi.setSize(window.innerWidth,window.innerHeight),mi.setAnimationLoop(_y),document.body.appendChild(mi.domElement),console.log("appended child"),Mr=new c0(mi);const e=new u0(ia,Lr);Mr.addPass(e);const t=new d0;Mr.addPass(t);const i=new p0;Mr.addPass(i),window.addEventListener("resize",gy)}function gy(){Lr.aspect=window.innerWidth/window.innerHeight,Lr.updateProjectionMatrix(),mi.setSize(window.innerWidth,window.innerHeight)}function _y(){wa.update(),Aa.uniforms.time.value=wa.getElapsed(),Mr.render()}const vy=[{path:"/",component:dy},{path:"/about-me",component:ty},{path:"/projects",component:cy},{path:"/contact",component:oy}],xy=YM({history:yM(),routes:vy});OS(KS).use(xy).mount("#app");
